    ...
    setWinIcon(self,AppFile("White.png"))
        ...
        LayoutButtonMain.setContentsmargins(0,0,0,0)
            ...
            for Col = 1 to 9
                ...
                TitleLet[Col] = new qLabel(win) { setFont( new qFont("Cambria",fontSize,50,0)) setAlignment(Qt_AlignHCenter | Qt_AlignVCenter) setStyleSheet("background-color:darkgray")   setText(Letter) } 
                Number++                
            next
            ...
            for Col = 1 to 8
                Letter = ""+ Col
                TitleNum[Col] = new qLabel(win) { setFont( new qFont("Cambria",fontSize,50,0)) setAlignment(Qt_AlignHCenter | Qt_AlignVCenter) setStyleSheet("background-color:darkgray")   setText(Letter) } 
                Number++            
...
SEE nl+ "===== START START ====="+nl+nl
    ...
    Button[4][4] { setIcon(new qIcon(new qPixMap(AppFile("Black.png"))))  setIconSize(new qSize(bWidth,bHeight)) }
    Button[5][5] { setIcon(new qIcon(new qPixMap(AppFile("Black.png"))))  setIconSize(new qSize(bWidth,bHeight)) }
    Button[4][5] { setIcon(new qIcon(new qPixMap(AppFile("White.png"))))  setIconSize(new qSize(bWidth,bHeight)) }
    Button[5][4] { setIcon(new qIcon(new qPixMap(AppFile("White.png"))))  setIconSize(new qSize(bWidth,bHeight)) }
...
FlagSkipTurn =  0       
    ...
    if curColor = "B"                                   ### Current BLACK   
        bArray[Row][Col] = "B"
        Button[Row][Col] { setIcon(new qIcon(new qPixMap(AppFile("Black.png"))))  setIconSize(new qSize(bWidth,bHeight)) }    
     
        CheckDiagonals(Row,Col,curColor)                ### >>>> CHECK Diagonals
                            
    elseif  curColor = "W"                              ### Current WHITE  
        bArray[Row][Col] = "W"      
        Button[Row][Col] { setIcon(new qIcon(new qPixMap(AppFile("White.png"))))  setIconSize(new qSize(bWidth,bHeight)) }
