...
func pcheckrightblack(n,m)
       ...
       for x = n+1 to size-1
            ...
            ok
       next
       if whiteno > n+1 and btnblack[whiteno][m] = 1
          flagblack = 1
...
func pcheckdownblack(n,m)
       ...
       for y = m+1 to size-1
            ...
            ok
       next
       if whiteno > m+1 and btnblack[n][whiteno] = 1
          flagblack = 1
...
func pcheckdiagdownrightblack(n,m)
       ...
       for x = 1 to size
            ...
            ok
       next
       if whiteno1 > n and btnblack[whiteno1][whiteno2] = 1
          flagblack = 1
          for nc = 1 to x
...
func pcheckdiagdownleftblack(n,m)
       ...
       if whiteno1 > 0 and whiteno2 > 0
          if whiteno1 < n-1 and btnblack[whiteno1][whiteno2] = 1
             flagblack = 1
             for nc = 1 to x
                  button[n-nc][m+nc].setenabled(false)
                  button[n-nc][m+nc] { setstylesheet(C_BUTTONBLACKSTYLE) }
...
func pcheckdiagupleftblack(n,m)
       ...
       for x = 1 to size
            ...
            ok
       next
       if whiteno1 > 0 and btnblack[whiteno1][whiteno2] = 1
          flagblack = 1
          for nc = 1 to x
               button[n-nc][m-nc].setenabled(false)
               button[n-nc][m-nc] { setstylesheet(C_BUTTONBLACKSTYLE) }
...
func pcheckrightwhite(n,m)
       ...
       for x = n+1 to size-1
            ...
            ok
       next
       if blackno > n+1 and btnwhite[blackno][m] = 1
          flagwhite = 1
...
func pcheckdownwhite(n,m)
       ...
       for y = m+1 to size-1
            ...
            ok
       next
       if blackno > m+1 and btnwhite[n][blackno] = 1
          flagwhite = 1
...
func pcheckdiagdownrightwhite(n,m)
       ...
       for x = 1 to size
            ...
            ok
       next
       if blackno1 > n and btnwhite[blackno1][blackno2] = 1
          flagwhite = 1
          for nc = 1 to x
               button[n+nc][m+nc].setenabled(false)
...
func pcheckdiagdownleftwhite(n,m)
       ...
       if blackno1 > 0 and blackno2 > 0
          if blackno1 < n-1 and btnwhite[blackno1][blackno2] = 1
             flagwhite = 1 
             for nc = 1 to x
                  button[n-nc][m+nc].setenabled(false)
                  button[n-nc][m+nc] { setstylesheet(C_BUTTONWHITESTYLE) }
...
func pcheckdiagupleftwhite(n,m)
       ...
       for x = 1 to size
            ...
            ok
       next
       if blackno1 > 0 and btnwhite[blackno1][blackno2] = 1
          flagwhite = 1
          for nc = 1 to x
               button[n-nc][m-nc].setenabled(false)
               button[n-nc][m-nc] { setstylesheet(C_BUTTONWHITESTYLE) }
