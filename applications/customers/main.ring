...
oApp = new QApp {
	...
	frameLClock.move(610,10)
	# frameLClock.setStylesheet("color:#0C6530")
	...
	checkAutoSearch = new qcheckbox(frmClients) {
		...
		else setGeometry(275,245,95,24)
		ok
		oFont = new qfont("",0,0,0)
		oFont.fromstring(labelFont)
		setfont(oFont)
	...
	lblFilter = new qLabel(frmClients) {
		setText(aLANGUAGE[:FILTER_BY])
		if T_LANGUAGE = "ar"
			setGeometry(400,240,95,30)
		else setGeometry(375,245,70,20)
		ok
		oFont = new qfont("",0,0,0)
		oFont.fromstring(labelFont)
		oFont.delete()
	...
	comboBox1 = new QComboBox(frmClients) {
		if T_LANGUAGE = "ar"
			setGeometry(355,245,70,20)
		else
			setGeometry(430,242,95,30)
		ok
		alist = [aLANGUAGE[:FILTER],"Ref","Nom","Email","Adresse","Clid"]
...
func pCbxIndexCanged
	...
	if cFilter = aLANGUAGE[:FILTER]
		...
		lblFilter.setstylesheet("color:#2b5392")
		comboBox1.setstylesheet("color:#2b5392")
	else 
		lblFilter.setstylesheet("color:#490383")
