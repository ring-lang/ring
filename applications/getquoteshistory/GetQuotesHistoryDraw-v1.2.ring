            ...
            if chartType = "Bar"
                for x = 1 to z
                    SplitAdjRatio = ( arrayAdjClose[x] / arrayClose[x] )
                     ...
                     yHi =     arrayHigh[x] * Scale ### Hi - NOW split  * SplitAdjRatio ### Split Adj
                     yLo =      arrayLow[x] * Scale ### Lo - NOW split  * SplitAdjRatio
                    #yCl =    arrayClose[x] * Scale ### CL - NOT split  * SplitAdjRatio
                     yCl = arrayAdjClose[x] * Scale ### Adj- IS  split
...
Func HeikenAshiCalc
        ...
        for i = 1 to z
            ...
            #haClose[i] = arrayClose[i]      ### * ScaleAdjClose
             haClose[i] = arrayAdjClose[i]   ### NEW YAHOO mess
