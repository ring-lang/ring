...
app = new qApp 
{
      win = new qWidget() {
	    ...
	    next
            ...
            labelMyChose = new QLabel(win) { setgeometry(width,300,150,20)
                                             setFont(new qFont("Verdana",C_FONTSIZE,50,0))
                                             settext("My Chose:") }

            labelCompChose = new QLabel(win) { setgeometry(width+380,300,150,20)
                                             setFont(new qFont("Verdana",C_FONTSIZE,50,0))
                                             settext("Comp Chose:") }

            labelScore = new QLabel(win) { setgeometry(width+150,600,70,20)
                                           setFont(new qFont("Verdana",C_FONTSIZE,50,0))
                                           settext("Score:") }

            labelScoreEnd = new QLabel(win) { setgeometry(width+220,600,170,20)
                                              setFont(new qFont("Verdana",C_FONTSIZE,50,0))
                                              settext("Computer Win!") }

	    btnMyChose = new QPushButton(win) { setgeometry(150,350,width,height) }

	    btnCompChose = new QPushButton(win) { setgeometry(550,350,width,height) }

            btnNewGame = new QPushButton(win) { setgeometry(170,670,150,40)
                                                setFont(new qFont("Verdana",C_FONTSIZE,50,0))
                                                setclickevent("pNewGame()")
                                                settext("New Game") }

            btnExit = new QPushButton(win) { setgeometry(580,670,150,40)
                                             setFont(new qFont("Verdana",C_FONTSIZE,50,0))
                                             setclickevent("pExit()")
                                             settext("Exit") }

            labelMyScore = new QLabel(win) { setgeometry(170,750,100,20)
                                             setFont(new qFont("Verdana",C_FONTSIZE,50,0))
                                             settext("My Score: ") }

            labelMyScoreSum = new QLabel(win) { setgeometry(300,750,100,20)
                                                setFont(new qFont("Verdana",C_FONTSIZE,50,0))
                                                settext("") }

            labelCompScore = new QLabel(win) { setgeometry(580,750,130,20)
                                               setFont(new qFont("Verdana",C_FONTSIZE,50,0))
                                               settext("Comp Score: ") }

            labelCompScoreSum = new QLabel(win) { setgeometry(730,750,100,20)
                                                  setFont(new qFont("Verdana",C_FONTSIZE,50,0))
                                                  settext("") }
...
func pButtonPress(Col)
     if nextPlayer = 1
        myChose = Col
        btnMyChose { seticon(new qicon(new qpixmap(ChoseList[Col])))
...
func compChose()
     ...
     compChose = rndChose
     btnCompChose { seticon(new qicon(new qpixmap(ChoseList[compChose])))
                    setIconSize(new qSize(width,height)) }
     nextPlayer = 1
     pResult()
...
func pNewGame()
     ...
     myScore = 0
     compScore = 0
     btnMyChose { seticon(new qicon(new qpixmap("")))
                  setIconSize(new qSize(200,200)) }

     btnCompChose { seticon(new qicon(new qpixmap("")))
                  setIconSize(new qSize(200,200)) }
