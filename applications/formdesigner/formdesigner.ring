...
class FormDesignerCodeGenerator
	...
	func Generate oDesigner,cFormFileName
		cSourceFileName = substr(cFormFileName,"rform","rform.ring")
		cClassName = GetFileNameOnlyWithoutPath(substr(cFormFileName,".rform","")) + "View"
		# Add the File Header 
			cOutput = "# Form/Window - Generated Source Code File " + nl +
