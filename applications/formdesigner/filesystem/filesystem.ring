			...
			for item in aObjectsList {
				...
				switch cClass {
					...
					case :FormDesigner_QLabel
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.LabelsCount())
					...
					case :FormDesigner_QPushButton
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.PushButtonsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QLineEdit
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.LineEditsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QTextEdit
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.TextEditsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QListWidget
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.ListWidgetsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QCheckBox
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.CheckBoxesCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QImage
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.ImagesCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QSlider
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.SlidersCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QProgressbar
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.ProgressBarsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QSpinBox
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.SpinBoxesCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QComboBox
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.ComboBoxesCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QDateTimeEdit
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.DateTimeEditsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QTableWidget
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.TableWidgetsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QTreeWidget
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.TreeWidgetsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QRadioButton
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.RadioButtonsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QWebView
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.WebViewsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QDial
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.DialsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QVideoWidget
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.VideoWidgetsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QFrame3
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.FramesCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QLCDNumber
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.LCDNumbersCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QHyperLink
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.HyperLinksCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QTimer
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.TimersCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QAllEvents
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.AllEventsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QLayout
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.LayoutsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QTabWidget
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.TabsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QStatusbar
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.StatusBarsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
					case :FormDesigner_QToolbar
						...
						oDesigner.CreateControlEvents(item[:name],oDesigner.oModel.ToolbarsCount())
						oDesigner.oModel.ActiveObject().RestoreProperties(oDesigner,item)
				}
			}
		# Objects List
