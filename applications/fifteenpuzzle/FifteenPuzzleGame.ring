...
func scramble  { 
	...
	for n = 1 to button_size*button_size step 1 { 
...
func resettiles  { 
	...
	for empty = 1 to button_size*button_size-1 step 1 { 
...
func newsize current_button { 
	win1 {
		...
		rightbtn.close()
		timebtn.close()
		for n = 1 to current_button*current_button step 1 { 
			...
			button[n] {
				...
				if n < current_button*current_button { 
					...
					elseif n = current_button*current_button
						button[n].settext("")
				} 
...
func pPlay  { 
	if flag_save = 0 OR flag_move = 0 { 
		warning()
			...
			for empty = 1 to button_size*button_size step 1 { 
				button[empty].setbuttoncolor("yellow")
				n_degree = number(table3[empty])
				btn_degree[empty][1] = table1[empty]
				button[empty] {
					settext(table1[empty])
				}
			} 
