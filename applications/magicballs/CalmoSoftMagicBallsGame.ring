...
balls = [   "images/blue.jpg",          "images/green.jpg",         "images/orange.jpg",
            ...
            "images/blueonblack.jpg",   "images/greenonblack.jpg",  "images/orangeonblack.jpg", 
            "images/redonblack.jpg",    "images/violetonblack.jpg", "images/yellowonblack.jpg", 
            "images/empty.jpg"]
...
func UserLeftClick(btn)                    // for click on a button
     ...
     if (ind > 0) and (cellType[btn] != C_EMPTY)
        ...
        if (hv != 0)
              ...
              ###----------------------------------------------------
              ### Call Functiom from load "solveArrayPathDest.ring"
