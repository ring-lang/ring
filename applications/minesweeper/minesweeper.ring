...
func emptycells(x,y)
       ...
       if x < C_ROWCOUNT and T[xx][y] = 0 minesok[xx][y] = 1 emptycells(xx,y) 
          else if minesum[xx][y] != 0 button[xx][y].settext(string(minesum[xx][y])) 
       ...
       if y > 1 and T[x][yy] = 0 minesok[x][yy] = 1 emptycells(x,yy) 
          else if minesum[x][yy] != 0 button[x][yy].settext(string(minesum[x][yy]))
...
func pnumber(pos1,pos2)
       ...
       ok
       if minenum = 0
          button[1][1].settext("K")
          if mines[1][1] = 1
             button[n][m].settext('L')
             button[n][m] {setbtnimage(self,"mine.png")}
             win.show()
          ok
       else
       ...
       if minenum = 0
          ...
          if mines[C_ROWCOUNT][C_COLCOUNT] = 1
             button[C_ROWCOUNT][C_COLCOUNT].settext('T')
          ...
          if mines[C_ROWCOUNT][C_COLCOUNT] = 0
             ...
             button[C_ROWCOUNT][C_COLCOUNT].settext('U')
             button[C_ROWCOUNT][C_COLCOUNT] {setbtnimage(self,"mine.png")}
             win.show()
          ok
       ok
       ...
       for n = 2 to C_ROWCOUNT-1
            ...
            ok
            if minenum = 0
               button[n][C_COLCOUNT].settext("C")
               if mines[n][C_COLCOUNT] = 1
                  button[n][C_COLCOUNT].settext('D')
