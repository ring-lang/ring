...
RING_FUNC(ring_al_new_allegro_event)
{
	...
	pMyPointer = (ALLEGRO_EVENT *) malloc(sizeof(ALLEGRO_EVENT)) ;
	if (pMyPointer == NULL) 
	{
...
RING_FUNC(ring_al_new_allegro_timeout)
{
	...
	pMyPointer = (ALLEGRO_TIMEOUT *) malloc(sizeof(ALLEGRO_TIMEOUT)) ;
	if (pMyPointer == NULL) 
	{
		RING_API_ERROR(RING_OOM);
		return ;
...
RING_FUNC(ring_al_new_allegro_sample_id)
{
	...
	pMyPointer = (ALLEGRO_SAMPLE_ID *) malloc(sizeof(ALLEGRO_SAMPLE_ID)) ;
	if (pMyPointer == NULL) 
	{
		RING_API_ERROR(RING_OOM);
		return ;
...
RING_FUNC(ring_al_new_allegro_color)
{
	...
	pMyPointer = (ALLEGRO_COLOR *) malloc(sizeof(ALLEGRO_COLOR)) ;
	if (pMyPointer == NULL) 
	{
		RING_API_ERROR(RING_OOM);
		return ;
...
RING_FUNC(ring_al_destroy_config)
{
	...
	al_destroy_config(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG"));
}
...
RING_FUNC(ring_al_load_config_file_f)
{
	...
	RING_API_RETCPOINTER(al_load_config_file_f(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")),"ALLEGRO_CONFIG");
}
...
RING_FUNC(ring_al_save_config_file)
{
	...
	RING_API_RETNUMBER(al_save_config_file(RING_API_GETSTRING(1),RING_API_GETCPOINTER(2,"ALLEGRO_CONFIG")));
}
...
RING_FUNC(ring_al_save_config_file_f)
{
	...
	RING_API_RETNUMBER(al_save_config_file_f(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETCPOINTER(2,"ALLEGRO_CONFIG")));
}
...
RING_FUNC(ring_al_add_config_section)
{
	...
	al_add_config_section(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG"),RING_API_GETSTRING(2));
}
...
RING_FUNC(ring_al_add_config_comment)
{
	...
	al_add_config_comment(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG"),RING_API_GETSTRING(2),RING_API_GETSTRING(3));
}
...
RING_FUNC(ring_al_get_config_value)
{
	...
	RING_API_RETSTRING(al_get_config_value(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG"),RING_API_GETSTRING(2),RING_API_GETSTRING(3)));
}
...
RING_FUNC(ring_al_set_config_value)
{
	...
	al_set_config_value(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG"),RING_API_GETSTRING(2),RING_API_GETSTRING(3),RING_API_GETSTRING(4));
}
...
RING_FUNC(ring_al_get_first_config_section)
{
	...
	RING_API_RETSTRING(al_get_first_config_section(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG"),RING_API_GETCPOINTER(2,"ALLEGRO_CONFIG_SECTION")));
}
...
RING_FUNC(ring_al_get_next_config_section)
{
	...
	RING_API_RETSTRING(al_get_next_config_section(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG_SECTION")));
}
...
RING_FUNC(ring_al_get_first_config_entry)
{
	...
	RING_API_RETSTRING(al_get_first_config_entry(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG"),RING_API_GETSTRING(2),RING_API_GETCPOINTER(3,"ALLEGRO_CONFIG_ENTRY")));
}
...
RING_FUNC(ring_al_get_next_config_entry)
{
	...
	RING_API_RETSTRING(al_get_next_config_entry(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG_ENTRY")));
}
...
RING_FUNC(ring_al_merge_config)
{
	...
	RING_API_RETCPOINTER(al_merge_config(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG"),RING_API_GETCPOINTER(2,"ALLEGRO_CONFIG")),"ALLEGRO_CONFIG");
}
...
RING_FUNC(ring_al_merge_config_into)
{
	...
	al_merge_config_into(RING_API_GETCPOINTER(1,"ALLEGRO_CONFIG"),RING_API_GETCPOINTER(2,"ALLEGRO_CONFIG"));
}
...
RING_FUNC(ring_al_create_display)
{
	...
	RING_API_RETCPOINTER(al_create_display(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2)),"ALLEGRO_DISPLAY");
}
...
RING_FUNC(ring_al_destroy_display)
{
	...
	al_destroy_display(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"));
}
...
RING_FUNC(ring_al_set_new_display_flags)
{
	...
	al_set_new_display_flags(RING_API_GETNUMBER(1));
}
...
RING_FUNC(ring_al_get_new_display_option)
{
	...
	RING_API_RETNUMBER(al_get_new_display_option(RING_API_GETNUMBER(1),RING_API_GETINTPOINTER(2)));
...
RING_FUNC(ring_al_set_new_display_option)
{
	...
	al_set_new_display_option(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
}
...
RING_FUNC(ring_al_set_new_window_position)
{
	...
	al_set_new_window_position(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2));
}
...
RING_FUNC(ring_al_set_new_display_refresh_rate)
{
	...
	al_set_new_display_refresh_rate(RING_API_GETNUMBER(1));
}
...
RING_FUNC(ring_al_get_display_event_source)
{
	...
	RING_API_RETCPOINTER(al_get_display_event_source(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")),"ALLEGRO_EVENT_SOURCE");
}
...
RING_FUNC(ring_al_get_backbuffer)
{
	...
	RING_API_RETCPOINTER(al_get_backbuffer(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")),"ALLEGRO_BITMAP");
}
...
RING_FUNC(ring_al_update_display_region)
{
	...
	al_update_display_region(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4));
}
...
RING_FUNC(ring_al_get_display_width)
{
	...
	RING_API_RETNUMBER(al_get_display_width(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_get_display_height)
{
	...
	RING_API_RETNUMBER(al_get_display_height(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_resize_display)
{
	...
	RING_API_RETNUMBER(al_resize_display(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_acknowledge_resize)
{
	...
	RING_API_RETNUMBER(al_acknowledge_resize(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_get_window_position)
{
	...
	al_get_window_position(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETINTPOINTER(2),RING_API_GETINTPOINTER(3));
	RING_API_ACCEPTINTVALUE(2) ;
...
RING_FUNC(ring_al_set_window_position)
{
	...
	al_set_window_position(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
}
...
RING_FUNC(ring_al_get_window_constraints)
{
	...
	RING_API_RETNUMBER(al_get_window_constraints(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETINTPOINTER(2),RING_API_GETINTPOINTER(3),RING_API_GETINTPOINTER(4),RING_API_GETINTPOINTER(5)));
	RING_API_ACCEPTINTVALUE(2) ;
	RING_API_ACCEPTINTVALUE(3) ;
...
RING_FUNC(ring_al_set_window_constraints)
{
	...
	RING_API_RETNUMBER(al_set_window_constraints(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5)));
}
...
RING_FUNC(ring_al_get_display_flags)
{
	...
	RING_API_RETNUMBER(al_get_display_flags(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_set_display_flag)
{
	...
	RING_API_RETNUMBER(al_set_display_flag(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_get_display_option)
{
	...
	RING_API_RETNUMBER(al_get_display_option(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_set_display_option)
{
	...
	al_set_display_option(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
}
...
RING_FUNC(ring_al_get_display_format)
{
	...
	RING_API_RETNUMBER(al_get_display_format(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_get_display_orientation)
{
	...
	RING_API_RETNUMBER(al_get_display_orientation(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_get_display_refresh_rate)
{
	...
	RING_API_RETNUMBER(al_get_display_refresh_rate(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_set_window_title)
{
	...
	al_set_window_title(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETSTRING(2));
}
...
RING_FUNC(ring_al_set_display_icon)
{
	...
	al_set_display_icon(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETCPOINTER(2,"ALLEGRO_BITMAP"));
}
...
RING_FUNC(ring_al_set_display_icons)
{
	...
	al_set_display_icons(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETNUMBER(2),RING_API_GETCPOINTER(3,"ALLEGRO_BITMAP"));
}
...
RING_FUNC(ring_al_acknowledge_drawing_halt)
{
	...
	al_acknowledge_drawing_halt(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"));
}
...
RING_FUNC(ring_al_acknowledge_drawing_resume)
{
	...
	al_acknowledge_drawing_resume(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"));
}
...
RING_FUNC(ring_al_inhibit_screensaver)
{
	...
	RING_API_RETNUMBER(al_inhibit_screensaver(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_destroy_event_queue)
{
	...
	al_destroy_event_queue(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE"));
}
...
RING_FUNC(ring_al_register_event_source)
{
	...
	al_register_event_source(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE"),RING_API_GETCPOINTER(2,"ALLEGRO_EVENT_SOURCE"));
}
...
RING_FUNC(ring_al_unregister_event_source)
{
	...
	al_unregister_event_source(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE"),RING_API_GETCPOINTER(2,"ALLEGRO_EVENT_SOURCE"));
}
...
RING_FUNC(ring_al_is_event_queue_empty)
{
	...
	RING_API_RETNUMBER(al_is_event_queue_empty(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE")));
}
...
RING_FUNC(ring_al_get_next_event)
{
	...
	RING_API_RETNUMBER(al_get_next_event(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE"),RING_API_GETCPOINTER(2,"ALLEGRO_EVENT")));
}
...
RING_FUNC(ring_al_peek_next_event)
{
	...
	RING_API_RETNUMBER(al_peek_next_event(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE"),RING_API_GETCPOINTER(2,"ALLEGRO_EVENT")));
}
...
RING_FUNC(ring_al_drop_next_event)
{
	...
	RING_API_RETNUMBER(al_drop_next_event(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE")));
}
...
RING_FUNC(ring_al_flush_event_queue)
{
	...
	al_flush_event_queue(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE"));
}
...
RING_FUNC(ring_al_wait_for_event)
{
	...
	al_wait_for_event(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE"),RING_API_GETCPOINTER(2,"ALLEGRO_EVENT"));
}
...
RING_FUNC(ring_al_wait_for_event_timed)
{
	...
	RING_API_RETNUMBER(al_wait_for_event_timed(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE"),RING_API_GETCPOINTER(2,"ALLEGRO_EVENT"),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_wait_for_event_until)
{
	...
	RING_API_RETNUMBER(al_wait_for_event_until(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_QUEUE"),RING_API_GETCPOINTER(2,"ALLEGRO_EVENT"),RING_API_GETCPOINTER(3,"ALLEGRO_TIMEOUT")));
}
...
RING_FUNC(ring_al_init_user_event_source)
{
	...
	al_init_user_event_source(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_SOURCE"));
}
...
RING_FUNC(ring_al_destroy_user_event_source)
{
	...
	al_destroy_user_event_source(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_SOURCE"));
}


RING_FUNC(ring_al_emit_user_event)
{
	if ( RING_API_PARACOUNT != 3 ) {
		RING_API_ERROR(RING_API_MISS3PARA);
		return ;
	...
	RING_API_RETNUMBER(al_emit_user_event(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_SOURCE"),RING_API_GETCPOINTER(2,"ALLEGRO_EVENT"),RING_API_GETCPOINTER(3,"void (dtor)(ALLEGRO_USER_EVENT")));
}
...
RING_FUNC(ring_al_unref_user_event)
{
	...
	al_unref_user_event(RING_API_GETCPOINTER(1,"ALLEGRO_USER_EVENT"));
}
...
RING_FUNC(ring_al_get_event_source_data)
{
	...
	{
		intptr_t *pValue ; 
		pValue = (intptr_t *) malloc(sizeof(intptr_t)) ;
		*pValue = al_get_event_source_data(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_SOURCE"));
...
RING_FUNC(ring_al_set_event_source_data)
{
	...
	al_set_event_source_data(RING_API_GETCPOINTER(1,"ALLEGRO_EVENT_SOURCE"),* (intptr_t  *) RING_API_GETCPOINTER(2,"intptr_t"));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"intptr_t"));
}
...
RING_FUNC(ring_al_fopen_interface)
{
	...
	RING_API_RETCPOINTER(al_fopen_interface(RING_API_GETCPOINTER(1,"ALLEGRO_FILE_INTERFACE"),RING_API_GETSTRING(2),RING_API_GETSTRING(3)),"ALLEGRO_FILE");
}
...
RING_FUNC(ring_al_fopen_slice)
{
	...
	RING_API_RETCPOINTER(al_fopen_slice(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3)),"ALLEGRO_FILE");
}
...
RING_FUNC(ring_al_fclose)
{
	...
	al_fclose(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"));
}
...
RING_FUNC(ring_al_fread)
{
	...
	RING_API_RETNUMBER(al_fread(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETCPOINTER(2,"void"),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_fwrite)
{
	...
	RING_API_RETNUMBER(al_fwrite(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETCPOINTER(2,"void"),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_fflush)
{
	...
	RING_API_RETNUMBER(al_fflush(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")));
}
...
RING_FUNC(ring_al_ftell)
{
	...
	RING_API_RETNUMBER(al_ftell(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")));
}
...
RING_FUNC(ring_al_fseek)
{
	...
	RING_API_RETNUMBER(al_fseek(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_feof)
{
	...
	RING_API_RETNUMBER(al_feof(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")));
}
...
RING_FUNC(ring_al_ferror)
{
	...
	RING_API_RETNUMBER(al_ferror(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")));
}
...
RING_FUNC(ring_al_fclearerr)
{
	...
	al_fclearerr(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"));
}
...
RING_FUNC(ring_al_fungetc)
{
	...
	RING_API_RETNUMBER(al_fungetc(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fsize)
{
	...
	RING_API_RETNUMBER(al_fsize(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")));
}
...
RING_FUNC(ring_al_fgetc)
{
	...
	RING_API_RETNUMBER(al_fgetc(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")));
}
...
RING_FUNC(ring_al_fputc)
{
	...
	RING_API_RETNUMBER(al_fputc(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fread16le)
{
	...
	RING_API_RETNUMBER(al_fread16le(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")));
}
...
RING_FUNC(ring_al_fread16be)
{
	...
	RING_API_RETNUMBER(al_fread16be(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")));
}
...
RING_FUNC(ring_al_fwrite16le)
{
	...
	RING_API_RETNUMBER(al_fwrite16le(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fwrite16be)
{
	...
	RING_API_RETNUMBER(al_fwrite16be(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fread32le)
{
	...
	RING_API_RETNUMBER(al_fread32le(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")));
}
...
RING_FUNC(ring_al_fread32be)
{
	...
	RING_API_RETNUMBER(al_fread32be(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")));
}
...
RING_FUNC(ring_al_fwrite32le)
{
	...
	RING_API_RETNUMBER(al_fwrite32le(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fwrite32be)
{
	...
	RING_API_RETNUMBER(al_fwrite32be(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fgets)
{
	...
	RING_API_RETCPOINTER(al_fgets(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),* (char * const  *) RING_API_GETCPOINTER(2,"char * const"),RING_API_GETNUMBER(3)),"char");
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"char"));
}
...
RING_FUNC(ring_al_fget_ustr)
{
	...
	RING_API_RETCPOINTER(al_fget_ustr(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")),"ALLEGRO_USTR");
}
...
RING_FUNC(ring_al_fputs)
{
	...
	RING_API_RETNUMBER(al_fputs(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETSTRING(2)));
}
...
RING_FUNC(ring_al_fopen_fd)
{
	...
	RING_API_RETCPOINTER(al_fopen_fd(RING_API_GETNUMBER(1),RING_API_GETSTRING(2)),"ALLEGRO_FILE");
}
...
RING_FUNC(ring_al_make_temp_file)
{
	...
	RING_API_RETCPOINTER(al_make_temp_file(RING_API_GETSTRING(1),RING_API_GETCPOINTER(2,"ALLEGRO_PATH")),"ALLEGRO_FILE");
}
...
RING_FUNC(ring_al_set_new_file_interface)
{
	...
	al_set_new_file_interface(RING_API_GETCPOINTER(1,"ALLEGRO_FILE_INTERFACE"));
}
...
RING_FUNC(ring_al_create_file_handle)
{
	...
	RING_API_RETCPOINTER(al_create_file_handle(RING_API_GETCPOINTER(1,"ALLEGRO_FILE_INTERFACE"),RING_API_GETCPOINTER(2,"void")),"ALLEGRO_FILE");
}
...
RING_FUNC(ring_al_get_file_userdata)
{
	...
	RING_API_RETCPOINTER(al_get_file_userdata(RING_API_GETCPOINTER(1,"ALLEGRO_FILE")),"void");
}
...
RING_FUNC(ring_al_destroy_fs_entry)
{
	...
	al_destroy_fs_entry(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY"));
}
...
RING_FUNC(ring_al_get_fs_entry_name)
{
	...
	RING_API_RETSTRING(al_get_fs_entry_name(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY")));
}
...
RING_FUNC(ring_al_update_fs_entry)
{
	...
	RING_API_RETNUMBER(al_update_fs_entry(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY")));
}
...
RING_FUNC(ring_al_get_fs_entry_mode)
{
	...
	RING_API_RETNUMBER(al_get_fs_entry_mode(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY")));
}
...
RING_FUNC(ring_al_get_fs_entry_atime)
{
	...
	}
	{
		...
		*pValue = al_get_fs_entry_atime(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY"));
...
RING_FUNC(ring_al_get_fs_entry_ctime)
{
	...
	}
	{
		time_t *pValue ; 
		pValue = (time_t *) malloc(sizeof(time_t)) ;
		*pValue = al_get_fs_entry_ctime(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY"));
		RING_API_RETCPOINTER(pValue,"time_t");
	}
}
...
RING_FUNC(ring_al_get_fs_entry_mtime)
{
	...
	}
	{
		time_t *pValue ; 
		pValue = (time_t *) malloc(sizeof(time_t)) ;
		*pValue = al_get_fs_entry_mtime(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY"));
		RING_API_RETCPOINTER(pValue,"time_t");
	}
}
...
RING_FUNC(ring_al_get_fs_entry_size)
{
	...
	{
		off_t *pValue ; 
		pValue = (off_t *) malloc(sizeof(off_t)) ;
		*pValue = al_get_fs_entry_size(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY"));
...
RING_FUNC(ring_al_fs_entry_exists)
{
	...
	RING_API_RETNUMBER(al_fs_entry_exists(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY")));
}
...
RING_FUNC(ring_al_remove_fs_entry)
{
	...
	RING_API_RETNUMBER(al_remove_fs_entry(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY")));
}
...
RING_FUNC(ring_al_open_directory)
{
	...
	RING_API_RETNUMBER(al_open_directory(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY")));
}
...
RING_FUNC(ring_al_read_directory)
{
	...
	RING_API_RETCPOINTER(al_read_directory(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY")),"ALLEGRO_FS_ENTRY");
}
...
RING_FUNC(ring_al_close_directory)
{
	...
	RING_API_RETNUMBER(al_close_directory(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY")));
}
...
RING_FUNC(ring_al_get_current_directory)
{
	...
	RING_API_RETCPOINTER(al_get_current_directory(),"char");
}
...
RING_FUNC(ring_al_open_fs_entry)
{
	...
	RING_API_RETCPOINTER(al_open_fs_entry(RING_API_GETCPOINTER(1,"ALLEGRO_FS_ENTRY"),RING_API_GETSTRING(2)),"ALLEGRO_FILE");
}
...
RING_FUNC(ring_al_set_fs_interface)
{
	...
	al_set_fs_interface(RING_API_GETCPOINTER(1,"ALLEGRO_FS_INTERFACE"));
}
...
RING_FUNC(ring_al_itofix)
{
	...
	RING_API_RETNUMBER(al_itofix(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixtoi)
{
	...
	RING_API_RETNUMBER(al_fixtoi(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixfloor)
{
	...
	RING_API_RETNUMBER(al_fixfloor(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixceil)
{
	...
	RING_API_RETNUMBER(al_fixceil(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_ftofix)
{
	...
	RING_API_RETNUMBER(al_ftofix(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixtof)
{
	...
	RING_API_RETNUMBER(al_fixtof(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixmul)
{
	...
	RING_API_RETNUMBER(al_fixmul(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fixdiv)
{
	...
	RING_API_RETNUMBER(al_fixdiv(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fixadd)
{
	...
	RING_API_RETNUMBER(al_fixadd(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fixsub)
{
	...
	RING_API_RETNUMBER(al_fixsub(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fixsin)
{
	...
	RING_API_RETNUMBER(al_fixsin(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixcos)
{
	...
	RING_API_RETNUMBER(al_fixcos(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixtan)
{
	...
	RING_API_RETNUMBER(al_fixtan(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixasin)
{
	...
	RING_API_RETNUMBER(al_fixasin(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixacos)
{
	...
	RING_API_RETNUMBER(al_fixacos(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixatan)
{
	...
	RING_API_RETNUMBER(al_fixatan(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixatan2)
{
	...
	RING_API_RETNUMBER(al_fixatan2(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_fixsqrt)
{
	...
	RING_API_RETNUMBER(al_fixsqrt(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_fixhypot)
{
	...
	RING_API_RETNUMBER(al_fixhypot(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_display_mode)
{
	...
	RING_API_RETCPOINTER(al_get_display_mode(RING_API_GETNUMBER(1),RING_API_GETCPOINTER(2,"ALLEGRO_DISPLAY_MODE")),"ALLEGRO_DISPLAY_MODE");
}
...
RING_FUNC(ring_al_map_rgb)
{
	...
	}
	{
		...
		pValue = (ALLEGRO_COLOR *) malloc(sizeof(ALLEGRO_COLOR)) ;
		*pValue = al_map_rgb(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
...
RING_FUNC(ring_al_map_rgb_f)
{
	...
	}
	{
		ALLEGRO_COLOR *pValue ; 
		pValue = (ALLEGRO_COLOR *) malloc(sizeof(ALLEGRO_COLOR)) ;
		*pValue = al_map_rgb_f(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_COLOR");
	}
}
...
RING_FUNC(ring_al_map_rgba)
{
	...
	}
	{
		ALLEGRO_COLOR *pValue ; 
		pValue = (ALLEGRO_COLOR *) malloc(sizeof(ALLEGRO_COLOR)) ;
		*pValue = al_map_rgba(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_COLOR");
	}
}
...
RING_FUNC(ring_al_map_rgba_f)
{
	...
	}
	{
		ALLEGRO_COLOR *pValue ; 
		pValue = (ALLEGRO_COLOR *) malloc(sizeof(ALLEGRO_COLOR)) ;
		*pValue = al_map_rgba_f(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_COLOR");
	}
}
...
RING_FUNC(ring_al_unmap_rgb)
{
	...
	al_unmap_rgb(* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(1,"ALLEGRO_COLOR"),RING_API_GETCPOINTER(2,"unsigned char"),RING_API_GETCPOINTER(3,"unsigned char"),RING_API_GETCPOINTER(4,"unsigned char"));
	if (RING_API_ISCPOINTERNOTASSIGNED(1))
		free(RING_API_GETCPOINTER(1,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_unmap_rgb_f)
{
	...
	al_unmap_rgb_f(* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(1,"ALLEGRO_COLOR"),RING_API_GETCPOINTER(2,"float"),RING_API_GETCPOINTER(3,"float"),RING_API_GETCPOINTER(4,"float"));
	if (RING_API_ISCPOINTERNOTASSIGNED(1))
		free(RING_API_GETCPOINTER(1,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_unmap_rgba)
{
	...
	al_unmap_rgba(* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(1,"ALLEGRO_COLOR"),RING_API_GETCPOINTER(2,"unsigned char"),RING_API_GETCPOINTER(3,"unsigned char"),RING_API_GETCPOINTER(4,"unsigned char"),RING_API_GETCPOINTER(5,"unsigned char"));
	if (RING_API_ISCPOINTERNOTASSIGNED(1))
		free(RING_API_GETCPOINTER(1,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_unmap_rgba_f)
{
	...
	al_unmap_rgba_f(* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(1,"ALLEGRO_COLOR"),RING_API_GETCPOINTER(2,"float"),RING_API_GETCPOINTER(3,"float"),RING_API_GETCPOINTER(4,"float"),RING_API_GETCPOINTER(5,"float"));
	if (RING_API_ISCPOINTERNOTASSIGNED(1))
		free(RING_API_GETCPOINTER(1,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_get_pixel_size)
{
	...
	RING_API_RETNUMBER(al_get_pixel_size(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_get_pixel_format_bits)
{
	...
	RING_API_RETNUMBER(al_get_pixel_format_bits(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_lock_bitmap)
{
	...
	RING_API_RETCPOINTER(al_lock_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)),"ALLEGRO_LOCKED_REGION");
}
...
RING_FUNC(ring_al_lock_bitmap_region)
{
	...
	RING_API_RETCPOINTER(al_lock_bitmap_region(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7)),"ALLEGRO_LOCKED_REGION");
}
...
RING_FUNC(ring_al_unlock_bitmap)
{
	...
	al_unlock_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"));
}
...
RING_FUNC(ring_al_create_bitmap)
{
	...
	RING_API_RETCPOINTER(al_create_bitmap(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2)),"ALLEGRO_BITMAP");
}
...
RING_FUNC(ring_al_create_sub_bitmap)
{
	...
	RING_API_RETCPOINTER(al_create_sub_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5)),"ALLEGRO_BITMAP");
}
...
RING_FUNC(ring_al_clone_bitmap)
{
	...
	RING_API_RETCPOINTER(al_clone_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP")),"ALLEGRO_BITMAP");
}
...
RING_FUNC(ring_al_destroy_bitmap)
{
	...
	al_destroy_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"));
}
...
RING_FUNC(ring_al_set_new_bitmap_flags)
{
	...
	al_set_new_bitmap_flags(RING_API_GETNUMBER(1));
}
...
RING_FUNC(ring_al_add_new_bitmap_flag)
{
	...
	al_add_new_bitmap_flag(RING_API_GETNUMBER(1));
}
...
RING_FUNC(ring_al_set_new_bitmap_format)
{
	...
	al_set_new_bitmap_format(RING_API_GETNUMBER(1));
}
...
RING_FUNC(ring_al_get_bitmap_flags)
{
	...
	RING_API_RETNUMBER(al_get_bitmap_flags(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP")));
}
...
RING_FUNC(ring_al_get_bitmap_format)
{
	...
	RING_API_RETNUMBER(al_get_bitmap_format(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP")));
}
...
RING_FUNC(ring_al_get_bitmap_height)
{
	...
	RING_API_RETNUMBER(al_get_bitmap_height(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP")));
}
...
RING_FUNC(ring_al_get_bitmap_width)
{
	...
	RING_API_RETNUMBER(al_get_bitmap_width(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP")));
}
...
RING_FUNC(ring_al_get_pixel)
{
	...
	}
	{
		ALLEGRO_COLOR *pValue ; 
		pValue = (ALLEGRO_COLOR *) malloc(sizeof(ALLEGRO_COLOR)) ;
		*pValue = al_get_pixel(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_COLOR");
	}
}
...
RING_FUNC(ring_al_is_bitmap_locked)
{
	...
	RING_API_RETNUMBER(al_is_bitmap_locked(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP")));
}
...
RING_FUNC(ring_al_is_compatible_bitmap)
{
	...
	RING_API_RETNUMBER(al_is_compatible_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP")));
}
...
RING_FUNC(ring_al_is_sub_bitmap)
{
	...
	RING_API_RETNUMBER(al_is_sub_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP")));
}
...
RING_FUNC(ring_al_get_parent_bitmap)
{
	...
	RING_API_RETCPOINTER(al_get_parent_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP")),"ALLEGRO_BITMAP");
}
...
RING_FUNC(ring_al_draw_bitmap)
{
	...
	al_draw_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4));
}
...
RING_FUNC(ring_al_draw_tinted_bitmap)
{
	...
	al_draw_tinted_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_bitmap_region)
{
	...
	al_draw_bitmap_region(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7),RING_API_GETNUMBER(8));
}
...
RING_FUNC(ring_al_draw_tinted_bitmap_region)
{
	...
	al_draw_tinted_bitmap_region(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7),RING_API_GETNUMBER(8),RING_API_GETNUMBER(9));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_pixel)
{
	...
	al_draw_pixel(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(3,"ALLEGRO_COLOR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_rotated_bitmap)
{
	...
	al_draw_rotated_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7));
}
...
RING_FUNC(ring_al_draw_tinted_rotated_bitmap)
{
	...
	al_draw_tinted_rotated_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7),RING_API_GETNUMBER(8));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_scaled_rotated_bitmap)
{
	...
	al_draw_scaled_rotated_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7),RING_API_GETNUMBER(8),RING_API_GETNUMBER(9));
}
...
RING_FUNC(ring_al_draw_tinted_scaled_rotated_bitmap)
{
	...
	al_draw_tinted_scaled_rotated_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7),RING_API_GETNUMBER(8),RING_API_GETNUMBER(9),RING_API_GETNUMBER(10));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_tinted_scaled_rotated_bitmap_region)
{
	...
	al_draw_tinted_scaled_rotated_bitmap_region(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(6,"ALLEGRO_COLOR"),RING_API_GETNUMBER(7),RING_API_GETNUMBER(8),RING_API_GETNUMBER(9),RING_API_GETNUMBER(10),RING_API_GETNUMBER(11),RING_API_GETNUMBER(12),RING_API_GETNUMBER(13),RING_API_GETNUMBER(14));
	if (RING_API_ISCPOINTERNOTASSIGNED(6))
		free(RING_API_GETCPOINTER(6,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_scaled_bitmap)
{
	...
	al_draw_scaled_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7),RING_API_GETNUMBER(8),RING_API_GETNUMBER(9),RING_API_GETNUMBER(10));
}
...
RING_FUNC(ring_al_draw_tinted_scaled_bitmap)
{
	...
	al_draw_tinted_scaled_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7),RING_API_GETNUMBER(8),RING_API_GETNUMBER(9),RING_API_GETNUMBER(10),RING_API_GETNUMBER(11));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_put_pixel)
{
	...
	al_put_pixel(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(3,"ALLEGRO_COLOR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_put_blended_pixel)
{
	...
	al_put_blended_pixel(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(3,"ALLEGRO_COLOR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_set_target_bitmap)
{
	...
	al_set_target_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"));
}
...
RING_FUNC(ring_al_set_target_backbuffer)
{
	...
	al_set_target_backbuffer(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"));
}
...
RING_FUNC(ring_al_set_blender)
{
	...
	al_set_blender(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
}
...
RING_FUNC(ring_al_set_separate_blender)
{
	...
	al_set_separate_blender(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6));
}
...
RING_FUNC(ring_al_set_clipping_rectangle)
{
	...
	al_set_clipping_rectangle(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4));
}
...
RING_FUNC(ring_al_convert_mask_to_alpha)
{
	...
	al_convert_mask_to_alpha(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_hold_bitmap_drawing)
{
	...
	al_hold_bitmap_drawing(RING_API_GETNUMBER(1));
}
...
RING_FUNC(ring_al_load_bitmap_f)
{
	...
	RING_API_RETCPOINTER(al_load_bitmap_f(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETSTRING(2)),"ALLEGRO_BITMAP");
}
...
RING_FUNC(ring_al_save_bitmap)
{
	...
	RING_API_RETNUMBER(al_save_bitmap(RING_API_GETSTRING(1),RING_API_GETCPOINTER(2,"ALLEGRO_BITMAP")));
}
...
RING_FUNC(ring_al_save_bitmap_f)
{
	...
	RING_API_RETNUMBER(al_save_bitmap_f(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETSTRING(2),RING_API_GETCPOINTER(3,"ALLEGRO_BITMAP")));
}
...
RING_FUNC(ring_al_get_joystick)
{
	...
	RING_API_RETCPOINTER(al_get_joystick(RING_API_GETNUMBER(1)),"ALLEGRO_JOYSTICK");
}
...
RING_FUNC(ring_al_release_joystick)
{
	...
	al_release_joystick(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK"));
}
...
RING_FUNC(ring_al_get_joystick_active)
{
	...
	RING_API_RETNUMBER(al_get_joystick_active(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK")));
}
...
RING_FUNC(ring_al_get_joystick_name)
{
	...
	RING_API_RETSTRING(al_get_joystick_name(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK")));
}
...
RING_FUNC(ring_al_get_joystick_stick_name)
{
	...
	RING_API_RETSTRING(al_get_joystick_stick_name(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_joystick_axis_name)
{
	...
	RING_API_RETSTRING(al_get_joystick_axis_name(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_get_joystick_button_name)
{
	...
	RING_API_RETSTRING(al_get_joystick_button_name(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_joystick_stick_flags)
{
	...
	RING_API_RETNUMBER(al_get_joystick_stick_flags(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_joystick_num_sticks)
{
	...
	RING_API_RETNUMBER(al_get_joystick_num_sticks(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK")));
}
...
RING_FUNC(ring_al_get_joystick_num_axes)
{
	...
	RING_API_RETNUMBER(al_get_joystick_num_axes(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_joystick_num_buttons)
{
	...
	RING_API_RETNUMBER(al_get_joystick_num_buttons(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK")));
}
...
RING_FUNC(ring_al_get_joystick_state)
{
	...
	al_get_joystick_state(RING_API_GETCPOINTER(1,"ALLEGRO_JOYSTICK"),RING_API_GETCPOINTER(2,"ALLEGRO_JOYSTICK_STATE"));
}
...
RING_FUNC(ring_al_get_keyboard_state)
{
	...
	al_get_keyboard_state(RING_API_GETCPOINTER(1,"ALLEGRO_KEYBOARD_STATE"));
}
...
RING_FUNC(ring_al_key_down)
{
	...
	RING_API_RETNUMBER(al_key_down(RING_API_GETCPOINTER(1,"ALLEGRO_KEYBOARD_STATE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_keycode_to_name)
{
	...
	RING_API_RETSTRING(al_keycode_to_name(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_set_keyboard_leds)
{
	...
	RING_API_RETNUMBER(al_set_keyboard_leds(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_malloc_with_context)
{
	...
	RING_API_RETCPOINTER(al_malloc_with_context(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETSTRING(3),RING_API_GETSTRING(4)),"void");
}
...
RING_FUNC(ring_al_free_with_context)
{
	...
	al_free_with_context(RING_API_GETCPOINTER(1,"void"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3),RING_API_GETSTRING(4));
}
...
RING_FUNC(ring_al_realloc_with_context)
{
	...
	RING_API_RETCPOINTER(al_realloc_with_context(RING_API_GETCPOINTER(1,"void"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETSTRING(4),RING_API_GETSTRING(5)),"void");
}
...
RING_FUNC(ring_al_calloc_with_context)
{
	...
	RING_API_RETCPOINTER(al_calloc_with_context(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETSTRING(4),RING_API_GETSTRING(5)),"void");
}
...
RING_FUNC(ring_al_set_memory_interface)
{
	...
	al_set_memory_interface(RING_API_GETCPOINTER(1,"ALLEGRO_MEMORY_INTERFACE"));
}
...
RING_FUNC(ring_al_set_new_display_adapter)
{
	...
	al_set_new_display_adapter(RING_API_GETNUMBER(1));
}
...
RING_FUNC(ring_al_get_monitor_info)
{
	...
	RING_API_RETNUMBER(al_get_monitor_info(RING_API_GETNUMBER(1),RING_API_GETCPOINTER(2,"ALLEGRO_MONITOR_INFO")));
}
...
RING_FUNC(ring_al_get_mouse_state)
{
	...
	al_get_mouse_state(RING_API_GETCPOINTER(1,"ALLEGRO_MOUSE_STATE"));
}
...
RING_FUNC(ring_al_get_mouse_state_axis)
{
	...
	RING_API_RETNUMBER(al_get_mouse_state_axis(RING_API_GETCPOINTER(1,"ALLEGRO_MOUSE_STATE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_mouse_button_down)
{
	...
	RING_API_RETNUMBER(al_mouse_button_down(RING_API_GETCPOINTER(1,"ALLEGRO_MOUSE_STATE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_set_mouse_xy)
{
	...
	RING_API_RETNUMBER(al_set_mouse_xy(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_set_mouse_z)
{
	...
	RING_API_RETNUMBER(al_set_mouse_z(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_set_mouse_w)
{
	...
	RING_API_RETNUMBER(al_set_mouse_w(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_set_mouse_axis)
{
	...
	RING_API_RETNUMBER(al_set_mouse_axis(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_create_mouse_cursor)
{
	...
	RING_API_RETCPOINTER(al_create_mouse_cursor(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)),"ALLEGRO_MOUSE_CURSOR");
}
...
RING_FUNC(ring_al_destroy_mouse_cursor)
{
	...
	al_destroy_mouse_cursor(RING_API_GETCPOINTER(1,"ALLEGRO_MOUSE_CURSOR"));
}
...
RING_FUNC(ring_al_set_mouse_cursor)
{
	...
	RING_API_RETNUMBER(al_set_mouse_cursor(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETCPOINTER(2,"ALLEGRO_MOUSE_CURSOR")));
}
...
RING_FUNC(ring_al_set_system_mouse_cursor)
{
	...
	RING_API_RETNUMBER(al_set_system_mouse_cursor(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),* (ALLEGRO_SYSTEM_MOUSE_CURSOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_SYSTEM_MOUSE_CURSOR")));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_SYSTEM_MOUSE_CURSOR"));
}
...
RING_FUNC(ring_al_hide_mouse_cursor)
{
	...
	RING_API_RETNUMBER(al_hide_mouse_cursor(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_show_mouse_cursor)
{
	...
	RING_API_RETNUMBER(al_show_mouse_cursor(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_grab_mouse)
{
	...
	RING_API_RETNUMBER(al_grab_mouse(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_destroy_path)
{
	...
	al_destroy_path(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"));
}
...
RING_FUNC(ring_al_clone_path)
{
	...
	RING_API_RETCPOINTER(al_clone_path(RING_API_GETCPOINTER(1,"ALLEGRO_PATH")),"ALLEGRO_PATH");
}
...
RING_FUNC(ring_al_join_paths)
{
	...
	RING_API_RETNUMBER(al_join_paths(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),RING_API_GETCPOINTER(2,"ALLEGRO_PATH")));
}
...
RING_FUNC(ring_al_rebase_path)
{
	...
	RING_API_RETNUMBER(al_rebase_path(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),RING_API_GETCPOINTER(2,"ALLEGRO_PATH")));
}
...
RING_FUNC(ring_al_get_path_drive)
{
	...
	RING_API_RETSTRING(al_get_path_drive(RING_API_GETCPOINTER(1,"ALLEGRO_PATH")));
}
...
RING_FUNC(ring_al_get_path_num_components)
{
	...
	RING_API_RETNUMBER(al_get_path_num_components(RING_API_GETCPOINTER(1,"ALLEGRO_PATH")));
}
...
RING_FUNC(ring_al_get_path_component)
{
	...
	RING_API_RETSTRING(al_get_path_component(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_path_tail)
{
	...
	RING_API_RETSTRING(al_get_path_tail(RING_API_GETCPOINTER(1,"ALLEGRO_PATH")));
}
...
RING_FUNC(ring_al_get_path_filename)
{
	...
	RING_API_RETSTRING(al_get_path_filename(RING_API_GETCPOINTER(1,"ALLEGRO_PATH")));
}
...
RING_FUNC(ring_al_get_path_basename)
{
	...
	RING_API_RETSTRING(al_get_path_basename(RING_API_GETCPOINTER(1,"ALLEGRO_PATH")));
}
...
RING_FUNC(ring_al_get_path_extension)
{
	...
	RING_API_RETSTRING(al_get_path_extension(RING_API_GETCPOINTER(1,"ALLEGRO_PATH")));
}
...
RING_FUNC(ring_al_set_path_drive)
{
	...
	al_set_path_drive(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),RING_API_GETSTRING(2));
}
...
RING_FUNC(ring_al_append_path_component)
{
	...
	al_append_path_component(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),RING_API_GETSTRING(2));
}
...
RING_FUNC(ring_al_insert_path_component)
{
	...
	al_insert_path_component(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3));
}
...
RING_FUNC(ring_al_replace_path_component)
{
	...
	al_replace_path_component(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3));
}
...
RING_FUNC(ring_al_remove_path_component)
{
	...
	al_remove_path_component(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),RING_API_GETNUMBER(2));
}
...
RING_FUNC(ring_al_drop_path_tail)
{
	...
	al_drop_path_tail(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"));
}
...
RING_FUNC(ring_al_set_path_filename)
{
	...
	al_set_path_filename(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),RING_API_GETSTRING(2));
}
...
RING_FUNC(ring_al_set_path_extension)
{
	...
	RING_API_RETNUMBER(al_set_path_extension(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),RING_API_GETSTRING(2)));
}
...
RING_FUNC(ring_al_path_cstr)
{
	...
	RING_API_RETSTRING(al_path_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_PATH"),* (char  *) RING_API_GETCPOINTER(2,"char")));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"char"));
}
...
RING_FUNC(ring_al_make_path_canonical)
{
	...
	RING_API_RETNUMBER(al_make_path_canonical(RING_API_GETCPOINTER(1,"ALLEGRO_PATH")));
}
...
RING_FUNC(ring_al_restore_state)
{
	...
	al_restore_state(RING_API_GETCPOINTER(1,"ALLEGRO_STATE"));
}
...
RING_FUNC(ring_al_store_state)
{
	...
	al_store_state(RING_API_GETCPOINTER(1,"ALLEGRO_STATE"),RING_API_GETNUMBER(2));
}
...
RING_FUNC(ring_al_set_errno)
{
	...
	al_set_errno(RING_API_GETNUMBER(1));
}
...
RING_FUNC(ring_al_get_standard_path)
{
	...
	RING_API_RETCPOINTER(al_get_standard_path(RING_API_GETNUMBER(1)),"ALLEGRO_PATH");
}
...
RING_FUNC(ring_al_start_thread)
{
	...
	al_start_thread(RING_API_GETCPOINTER(1,"ALLEGRO_THREAD"));
}
...
RING_FUNC(ring_al_join_thread)
{
	...
	al_join_thread(RING_API_GETCPOINTER(1,"ALLEGRO_THREAD"),RING_API_GETCPOINTER(2,"void"));
}
...
RING_FUNC(ring_al_set_thread_should_stop)
{
	...
	al_set_thread_should_stop(RING_API_GETCPOINTER(1,"ALLEGRO_THREAD"));
}
...
RING_FUNC(ring_al_get_thread_should_stop)
{
	...
	RING_API_RETNUMBER(al_get_thread_should_stop(RING_API_GETCPOINTER(1,"ALLEGRO_THREAD")));
}
...
RING_FUNC(ring_al_destroy_thread)
{
	...
	al_destroy_thread(RING_API_GETCPOINTER(1,"ALLEGRO_THREAD"));
}
...
RING_FUNC(ring_al_lock_mutex)
{
	...
	al_lock_mutex(RING_API_GETCPOINTER(1,"ALLEGRO_MUTEX"));
}
...
RING_FUNC(ring_al_unlock_mutex)
{
	...
	al_unlock_mutex(RING_API_GETCPOINTER(1,"ALLEGRO_MUTEX"));
}
...
RING_FUNC(ring_al_destroy_mutex)
{
	...
	al_destroy_mutex(RING_API_GETCPOINTER(1,"ALLEGRO_MUTEX"));
}
...
RING_FUNC(ring_al_destroy_cond)
{
	...
	al_destroy_cond(RING_API_GETCPOINTER(1,"ALLEGRO_COND"));
}
...
RING_FUNC(ring_al_wait_cond)
{
	...
	al_wait_cond(RING_API_GETCPOINTER(1,"ALLEGRO_COND"),RING_API_GETCPOINTER(2,"ALLEGRO_MUTEX"));
}
...
RING_FUNC(ring_al_wait_cond_until)
{
	...
	RING_API_RETNUMBER(al_wait_cond_until(RING_API_GETCPOINTER(1,"ALLEGRO_COND"),RING_API_GETCPOINTER(2,"ALLEGRO_MUTEX"),RING_API_GETCPOINTER(3,"ALLEGRO_TIMEOUT")));
}
...
RING_FUNC(ring_al_broadcast_cond)
{
	...
	al_broadcast_cond(RING_API_GETCPOINTER(1,"ALLEGRO_COND"));
}
...
RING_FUNC(ring_al_signal_cond)
{
	...
	al_signal_cond(RING_API_GETCPOINTER(1,"ALLEGRO_COND"));
}
...
RING_FUNC(ring_al_init_timeout)
{
	...
	al_init_timeout(RING_API_GETCPOINTER(1,"ALLEGRO_TIMEOUT"),RING_API_GETNUMBER(2));
}
...
RING_FUNC(ring_al_create_timer)
{
	...
	RING_API_RETCPOINTER(al_create_timer(RING_API_GETNUMBER(1)),"ALLEGRO_TIMER");
}
...
RING_FUNC(ring_al_start_timer)
{
	...
	al_start_timer(RING_API_GETCPOINTER(1,"ALLEGRO_TIMER"));
}
...
RING_FUNC(ring_al_stop_timer)
{
	...
	al_stop_timer(RING_API_GETCPOINTER(1,"ALLEGRO_TIMER"));
}
...
RING_FUNC(ring_al_get_timer_started)
{
	...
	RING_API_RETNUMBER(al_get_timer_started(RING_API_GETCPOINTER(1,"ALLEGRO_TIMER")));
}
...
RING_FUNC(ring_al_destroy_timer)
{
	...
	al_destroy_timer(RING_API_GETCPOINTER(1,"ALLEGRO_TIMER"));
}
...
RING_FUNC(ring_al_get_timer_count)
{
	...
	RING_API_RETNUMBER(al_get_timer_count(RING_API_GETCPOINTER(1,"ALLEGRO_TIMER")));
}
...
RING_FUNC(ring_al_set_timer_count)
{
	...
	al_set_timer_count(RING_API_GETCPOINTER(1,"ALLEGRO_TIMER"),RING_API_GETNUMBER(2));
}
...
RING_FUNC(ring_al_add_timer_count)
{
	...
	al_add_timer_count(RING_API_GETCPOINTER(1,"ALLEGRO_TIMER"),RING_API_GETNUMBER(2));
}
...
RING_FUNC(ring_al_get_timer_speed)
{
	...
	RING_API_RETNUMBER(al_get_timer_speed(RING_API_GETCPOINTER(1,"ALLEGRO_TIMER")));
}
...
RING_FUNC(ring_al_set_timer_speed)
{
	...
	al_set_timer_speed(RING_API_GETCPOINTER(1,"ALLEGRO_TIMER"),RING_API_GETNUMBER(2));
}
...
RING_FUNC(ring_al_get_timer_event_source)
{
	...
	RING_API_RETCPOINTER(al_get_timer_event_source(RING_API_GETCPOINTER(1,"ALLEGRO_TIMER")),"ALLEGRO_EVENT_SOURCE");
}
...
RING_FUNC(ring_al_copy_transform)
{
	...
	al_copy_transform(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"),RING_API_GETCPOINTER(2,"ALLEGRO_TRANSFORM"));
}
...
RING_FUNC(ring_al_use_transform)
{
	...
	al_use_transform(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"));
}
...
RING_FUNC(ring_al_invert_transform)
{
	...
	al_invert_transform(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"));
}
...
RING_FUNC(ring_al_check_inverse)
{
	...
	RING_API_RETNUMBER(al_check_inverse(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_identity_transform)
{
	...
	al_identity_transform(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"));
}
...
RING_FUNC(ring_al_build_transform)
{
	...
	al_build_transform(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6));
}
...
RING_FUNC(ring_al_translate_transform)
{
	...
	al_translate_transform(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
}
...
RING_FUNC(ring_al_rotate_transform)
{
	...
	al_rotate_transform(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"),RING_API_GETNUMBER(2));
}
...
RING_FUNC(ring_al_scale_transform)
{
	...
	al_scale_transform(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
}
...
RING_FUNC(ring_al_transform_coordinates)
{
	...
	al_transform_coordinates(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"),RING_API_GETCPOINTER(2,"float"),RING_API_GETCPOINTER(3,"float"));
}
...
RING_FUNC(ring_al_compose_transform)
{
	...
	al_compose_transform(RING_API_GETCPOINTER(1,"ALLEGRO_TRANSFORM"),RING_API_GETCPOINTER(2,"ALLEGRO_TRANSFORM"));
}
...
RING_FUNC(ring_al_ustr_new_from_buffer)
{
	...
	RING_API_RETCPOINTER(al_ustr_new_from_buffer(RING_API_GETSTRING(1),RING_API_GETNUMBER(2)),"ALLEGRO_USTR");
}
...
RING_FUNC(ring_al_ustr_free)
{
	...
	al_ustr_free(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"));
}
...
RING_FUNC(ring_al_cstr)
{
	...
	RING_API_RETSTRING(al_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_to_buffer)
{
	...
	al_ustr_to_buffer(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETCPOINTER(2,"char"),RING_API_GETNUMBER(3));
}
...
RING_FUNC(ring_al_cstr_dup)
{
	...
	RING_API_RETCPOINTER(al_cstr_dup(RING_API_GETCPOINTER(1,"ALLEGRO_USTR")),"char");
}
...
RING_FUNC(ring_al_ustr_dup)
{
	...
	RING_API_RETCPOINTER(al_ustr_dup(RING_API_GETCPOINTER(1,"ALLEGRO_USTR")),"ALLEGRO_USTR");
}
...
RING_FUNC(ring_al_ustr_dup_substr)
{
	...
	RING_API_RETCPOINTER(al_ustr_dup_substr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)),"ALLEGRO_USTR");
}
...
RING_FUNC(ring_al_ref_cstr)
{
	...
	RING_API_RETCPOINTER(al_ref_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR_INFO"),RING_API_GETSTRING(2)),"ALLEGRO_USTR");
}
...
RING_FUNC(ring_al_ref_buffer)
{
	...
	RING_API_RETCPOINTER(al_ref_buffer(RING_API_GETCPOINTER(1,"ALLEGRO_USTR_INFO"),RING_API_GETSTRING(2),RING_API_GETNUMBER(3)),"ALLEGRO_USTR");
}
...
RING_FUNC(ring_al_ref_ustr)
{
	...
	RING_API_RETCPOINTER(al_ref_ustr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR_INFO"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4)),"ALLEGRO_USTR");
}
...
RING_FUNC(ring_al_ustr_size)
{
	...
	RING_API_RETNUMBER(al_ustr_size(RING_API_GETCPOINTER(1,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_length)
{
	...
	RING_API_RETNUMBER(al_ustr_length(RING_API_GETCPOINTER(1,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_offset)
{
	...
	RING_API_RETNUMBER(al_ustr_offset(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_ustr_next)
{
	...
	RING_API_RETNUMBER(al_ustr_next(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETINTPOINTER(2)));
	RING_API_ACCEPTINTVALUE(2) ;
}
...
RING_FUNC(ring_al_ustr_prev)
{
	...
	RING_API_RETNUMBER(al_ustr_prev(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETINTPOINTER(2)));
	RING_API_ACCEPTINTVALUE(2) ;
}
...
RING_FUNC(ring_al_ustr_get)
{
	...
	RING_API_RETNUMBER(al_ustr_get(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_ustr_get_next)
{
	...
	RING_API_RETNUMBER(al_ustr_get_next(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETINTPOINTER(2)));
	RING_API_ACCEPTINTVALUE(2) ;
}
...
RING_FUNC(ring_al_ustr_prev_get)
{
	...
	RING_API_RETNUMBER(al_ustr_prev_get(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETINTPOINTER(2)));
	RING_API_ACCEPTINTVALUE(2) ;
}
...
RING_FUNC(ring_al_ustr_insert)
{
	...
	RING_API_RETNUMBER(al_ustr_insert(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETCPOINTER(3,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_insert_cstr)
{
	...
	RING_API_RETNUMBER(al_ustr_insert_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3)));
}
...
RING_FUNC(ring_al_ustr_insert_chr)
{
	...
	RING_API_RETNUMBER(al_ustr_insert_chr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_ustr_append)
{
	...
	RING_API_RETNUMBER(al_ustr_append(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_append_cstr)
{
	...
	RING_API_RETNUMBER(al_ustr_append_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETSTRING(2)));
}
...
RING_FUNC(ring_al_ustr_append_chr)
{
	...
	RING_API_RETNUMBER(al_ustr_append_chr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_ustr_vappendf)
{
	...
	RING_API_RETNUMBER(al_ustr_vappendf(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETSTRING(2),* (va_list  *) RING_API_GETCPOINTER(3,"va_list")));
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"va_list"));
}
...
RING_FUNC(ring_al_ustr_remove_chr)
{
	...
	RING_API_RETNUMBER(al_ustr_remove_chr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_ustr_remove_range)
{
	...
	RING_API_RETNUMBER(al_ustr_remove_range(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_ustr_truncate)
{
	...
	RING_API_RETNUMBER(al_ustr_truncate(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_ustr_ltrim_ws)
{
	...
	RING_API_RETNUMBER(al_ustr_ltrim_ws(RING_API_GETCPOINTER(1,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_rtrim_ws)
{
	...
	RING_API_RETNUMBER(al_ustr_rtrim_ws(RING_API_GETCPOINTER(1,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_trim_ws)
{
	...
	RING_API_RETNUMBER(al_ustr_trim_ws(RING_API_GETCPOINTER(1,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_assign)
{
	...
	RING_API_RETNUMBER(al_ustr_assign(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_assign_substr)
{
	...
	RING_API_RETNUMBER(al_ustr_assign_substr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4)));
}
...
RING_FUNC(ring_al_ustr_assign_cstr)
{
	...
	RING_API_RETNUMBER(al_ustr_assign_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETSTRING(2)));
}
...
RING_FUNC(ring_al_ustr_set_chr)
{
	...
	RING_API_RETNUMBER(al_ustr_set_chr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_ustr_replace_range)
{
	...
	RING_API_RETNUMBER(al_ustr_replace_range(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETCPOINTER(4,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_find_chr)
{
	...
	RING_API_RETNUMBER(al_ustr_find_chr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_ustr_rfind_chr)
{
	...
	RING_API_RETNUMBER(al_ustr_rfind_chr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_ustr_find_set)
{
	...
	RING_API_RETNUMBER(al_ustr_find_set(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETCPOINTER(3,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_find_set_cstr)
{
	...
	RING_API_RETNUMBER(al_ustr_find_set_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3)));
}
...
RING_FUNC(ring_al_ustr_find_cset)
{
	...
	RING_API_RETNUMBER(al_ustr_find_cset(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETCPOINTER(3,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_find_cset_cstr)
{
	...
	RING_API_RETNUMBER(al_ustr_find_cset_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3)));
}
...
RING_FUNC(ring_al_ustr_find_str)
{
	...
	RING_API_RETNUMBER(al_ustr_find_str(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETCPOINTER(3,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_find_cstr)
{
	...
	RING_API_RETNUMBER(al_ustr_find_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3)));
}
...
RING_FUNC(ring_al_ustr_rfind_str)
{
	...
	RING_API_RETNUMBER(al_ustr_rfind_str(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETCPOINTER(3,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_rfind_cstr)
{
	...
	RING_API_RETNUMBER(al_ustr_rfind_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3)));
}
...
RING_FUNC(ring_al_ustr_find_replace)
{
	...
	RING_API_RETNUMBER(al_ustr_find_replace(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETCPOINTER(3,"ALLEGRO_USTR"),RING_API_GETCPOINTER(4,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_find_replace_cstr)
{
	...
	RING_API_RETNUMBER(al_ustr_find_replace_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3),RING_API_GETSTRING(4)));
}
...
RING_FUNC(ring_al_ustr_compare)
{
	...
	RING_API_RETNUMBER(al_ustr_compare(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_ncompare)
{
	...
	RING_API_RETNUMBER(al_ustr_ncompare(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR"),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_ustr_equal)
{
	...
	RING_API_RETNUMBER(al_ustr_equal(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_has_prefix)
{
	...
	RING_API_RETNUMBER(al_ustr_has_prefix(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_has_prefix_cstr)
{
	...
	RING_API_RETNUMBER(al_ustr_has_prefix_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETSTRING(2)));
}
...
RING_FUNC(ring_al_ustr_has_suffix)
{
	...
	RING_API_RETNUMBER(al_ustr_has_suffix(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_has_suffix_cstr)
{
	...
	RING_API_RETNUMBER(al_ustr_has_suffix_cstr(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETSTRING(2)));
}
...
RING_FUNC(ring_al_ustr_new_from_utf16)
{
	...
	RING_API_RETCPOINTER(al_ustr_new_from_utf16(RING_API_GETCPOINTER(1,"uint16_t")),"ALLEGRO_USTR");
}
...
RING_FUNC(ring_al_ustr_size_utf16)
{
	...
	RING_API_RETNUMBER(al_ustr_size_utf16(RING_API_GETCPOINTER(1,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_ustr_encode_utf16)
{
	...
	RING_API_RETNUMBER(al_ustr_encode_utf16(RING_API_GETCPOINTER(1,"ALLEGRO_USTR"),RING_API_GETCPOINTER(2,"uint16_t"),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_utf8_width)
{
	...
	RING_API_RETNUMBER(al_utf8_width(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_utf8_encode)
{
	...
	RING_API_RETNUMBER(al_utf8_encode(* (char  *) RING_API_GETCPOINTER(1,"char"),RING_API_GETNUMBER(2)));
	if (RING_API_ISCPOINTERNOTASSIGNED(1))
		free(RING_API_GETCPOINTER(1,"char"));
}
...
RING_FUNC(ring_al_utf16_width)
{
	...
	RING_API_RETNUMBER(al_utf16_width(RING_API_GETNUMBER(1)));
}


RING_FUNC(ring_al_utf16_encode)
{
	if ( RING_API_PARACOUNT != 2 ) {
		RING_API_ERROR(RING_API_MISS2PARA);
		return ;
	...
	RING_API_RETNUMBER(al_utf16_encode(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_d3d_device)
{
	...
	}
	{
		...
		pValue = (LPDIRECT3DDEVICE9 *) malloc(sizeof(LPDIRECT3DDEVICE9)) ;
		*pValue = al_get_d3d_device(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"));
...
RING_FUNC(ring_al_get_d3d_system_texture)
{
	...
	}
	{
		...
		pValue = (LPDIRECT3DTEXTURE9 *) malloc(sizeof(LPDIRECT3DTEXTURE9)) ;
		*pValue = al_get_d3d_system_texture(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"));
...
RING_FUNC(ring_al_get_d3d_video_texture)
{
	...
	}
	{
		LPDIRECT3DTEXTURE9 *pValue ; 
		pValue = (LPDIRECT3DTEXTURE9 *) malloc(sizeof(LPDIRECT3DTEXTURE9)) ;
		*pValue = al_get_d3d_video_texture(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"));
		RING_API_RETCPOINTER(pValue,"LPDIRECT3DTEXTURE9");
	}
}
...
RING_FUNC(ring_al_get_d3d_texture_position)
{
	...
	al_get_d3d_texture_position(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETINTPOINTER(2),RING_API_GETINTPOINTER(3));
	RING_API_ACCEPTINTVALUE(2) ;
	RING_API_ACCEPTINTVALUE(3) ;
}
...
RING_FUNC(ring_al_is_d3d_device_lost)
{
	...
	RING_API_RETNUMBER(al_is_d3d_device_lost(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY")));
}
...
RING_FUNC(ring_al_get_opengl_texture)
{
	...
	}
	{
		...
		*pValue = al_get_opengl_texture(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"));
...
RING_FUNC(ring_al_get_opengl_texture_size)
{
	...
	al_get_opengl_texture_size(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETINTPOINTER(2),RING_API_GETINTPOINTER(3));
	RING_API_ACCEPTINTVALUE(2) ;
	RING_API_ACCEPTINTVALUE(3) ;
}
...
RING_FUNC(ring_al_get_opengl_texture_position)
{
	...
	al_get_opengl_texture_position(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETINTPOINTER(2),RING_API_GETINTPOINTER(3));
	RING_API_ACCEPTINTVALUE(2) ;
	RING_API_ACCEPTINTVALUE(3) ;
}
...
RING_FUNC(ring_al_get_opengl_fbo)
{
	...
	}
	{
		GLuint *pValue ; 
		pValue = (GLuint *) malloc(sizeof(GLuint)) ;
		*pValue = al_get_opengl_fbo(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"));
		RING_API_RETCPOINTER(pValue,"GLuint");
	}
}
...
RING_FUNC(ring_al_remove_opengl_fbo)
{
	...
	al_remove_opengl_fbo(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"));
}
...
RING_FUNC(ring_al_set_current_opengl_context)
{
	...
	al_set_current_opengl_context(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"));
}
...
RING_FUNC(ring_al_reserve_samples)
{
	...
	RING_API_RETNUMBER(al_reserve_samples(RING_API_GETNUMBER(1)));
}
...
RING_FUNC(ring_al_get_audio_depth_size)
{
	...
	if (RING_API_ISCPOINTERNOTASSIGNED(1))
		free(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_DEPTH"));
}
...
RING_FUNC(ring_al_get_channel_count)
{
	...
	if (RING_API_ISCPOINTERNOTASSIGNED(1))
		free(RING_API_GETCPOINTER(1,"ALLEGRO_CHANNEL_CONF"));
}
...
RING_FUNC(ring_al_create_voice)
{
	...
	if (RING_API_ISCPOINTERNOTASSIGNED(1))
		free(RING_API_GETCPOINTER(1,"unsigned int"));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_AUDIO_DEPTH"));
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"ALLEGRO_CHANNEL_CONF"));
}
...
RING_FUNC(ring_al_destroy_voice)
{
	...
	al_destroy_voice(RING_API_GETCPOINTER(1,"ALLEGRO_VOICE"));
}
...
RING_FUNC(ring_al_detach_voice)
{
	...
	al_detach_voice(RING_API_GETCPOINTER(1,"ALLEGRO_VOICE"));
}
...
RING_FUNC(ring_al_attach_audio_stream_to_voice)
{
	...
	RING_API_RETNUMBER(al_attach_audio_stream_to_voice(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"),RING_API_GETCPOINTER(2,"ALLEGRO_VOICE")));
}
...
RING_FUNC(ring_al_attach_mixer_to_voice)
{
	...
	RING_API_RETNUMBER(al_attach_mixer_to_voice(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"),RING_API_GETCPOINTER(2,"ALLEGRO_VOICE")));
}
...
RING_FUNC(ring_al_attach_sample_instance_to_voice)
{
	...
	RING_API_RETNUMBER(al_attach_sample_instance_to_voice(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"),RING_API_GETCPOINTER(2,"ALLEGRO_VOICE")));
}
...
RING_FUNC(ring_al_get_voice_frequency)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_voice_frequency(RING_API_GETCPOINTER(1,"ALLEGRO_VOICE"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_get_voice_channels)
{
	...
	}
	{
		...
		pValue = (ALLEGRO_CHANNEL_CONF *) malloc(sizeof(ALLEGRO_CHANNEL_CONF)) ;
		*pValue = al_get_voice_channels(RING_API_GETCPOINTER(1,"ALLEGRO_VOICE"));
...
RING_FUNC(ring_al_get_voice_depth)
{
	...
	}
	{
		...
		pValue = (ALLEGRO_AUDIO_DEPTH *) malloc(sizeof(ALLEGRO_AUDIO_DEPTH)) ;
		*pValue = al_get_voice_depth(RING_API_GETCPOINTER(1,"ALLEGRO_VOICE"));
...
RING_FUNC(ring_al_get_voice_playing)
{
	...
	RING_API_RETNUMBER(al_get_voice_playing(RING_API_GETCPOINTER(1,"ALLEGRO_VOICE")));
}
...
RING_FUNC(ring_al_set_voice_playing)
{
	...
	RING_API_RETNUMBER(al_set_voice_playing(RING_API_GETCPOINTER(1,"ALLEGRO_VOICE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_voice_position)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_voice_position(RING_API_GETCPOINTER(1,"ALLEGRO_VOICE"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_set_voice_position)
{
	...
	RING_API_RETNUMBER(al_set_voice_position(RING_API_GETCPOINTER(1,"ALLEGRO_VOICE"),* (unsigned int  *) RING_API_GETCPOINTER(2,"unsigned int")));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"unsigned int"));
}
...
RING_FUNC(ring_al_create_sample)
{
	...
	RING_API_RETCPOINTER(al_create_sample(RING_API_GETCPOINTER(1,"void"),* (unsigned int  *) RING_API_GETCPOINTER(2,"unsigned int"),* (unsigned int  *) RING_API_GETCPOINTER(3,"unsigned int"),* (ALLEGRO_AUDIO_DEPTH  *) RING_API_GETCPOINTER(4,"ALLEGRO_AUDIO_DEPTH"),* (ALLEGRO_CHANNEL_CONF  *) RING_API_GETCPOINTER(5,"ALLEGRO_CHANNEL_CONF"),RING_API_GETNUMBER(6)),"ALLEGRO_SAMPLE");
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"unsigned int"));
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"unsigned int"));
	if (RING_API_ISCPOINTERNOTASSIGNED(4))
		free(RING_API_GETCPOINTER(4,"ALLEGRO_AUDIO_DEPTH"));
	if (RING_API_ISCPOINTERNOTASSIGNED(5))
		free(RING_API_GETCPOINTER(5,"ALLEGRO_CHANNEL_CONF"));
}
...
RING_FUNC(ring_al_destroy_sample)
{
	...
	al_destroy_sample(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE"));
}
...
RING_FUNC(ring_al_play_sample)
{
	...
	RING_API_RETNUMBER(al_play_sample(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),* (ALLEGRO_PLAYMODE  *) RING_API_GETCPOINTER(5,"ALLEGRO_PLAYMODE"),RING_API_GETCPOINTER(6,"ALLEGRO_SAMPLE_ID")));
	if (RING_API_ISCPOINTERNOTASSIGNED(5))
		free(RING_API_GETCPOINTER(5,"ALLEGRO_PLAYMODE"));
}
...
RING_FUNC(ring_al_stop_sample)
{
	...
	al_stop_sample(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_ID"));
}
...
RING_FUNC(ring_al_get_sample_channels)
{
	...
	}
	{
		ALLEGRO_CHANNEL_CONF *pValue ; 
		pValue = (ALLEGRO_CHANNEL_CONF *) malloc(sizeof(ALLEGRO_CHANNEL_CONF)) ;
		*pValue = al_get_sample_channels(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE"));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_CHANNEL_CONF");
	}
}
...
RING_FUNC(ring_al_get_sample_depth)
{
	...
	}
	{
		ALLEGRO_AUDIO_DEPTH *pValue ; 
		pValue = (ALLEGRO_AUDIO_DEPTH *) malloc(sizeof(ALLEGRO_AUDIO_DEPTH)) ;
		*pValue = al_get_sample_depth(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE"));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_AUDIO_DEPTH");
	}
}
...
RING_FUNC(ring_al_get_sample_frequency)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_sample_frequency(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_get_sample_length)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_sample_length(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_get_sample_data)
{
	...
	RING_API_RETCPOINTER(al_get_sample_data(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE")),"void");
}
...
RING_FUNC(ring_al_create_sample_instance)
{
	...
	RING_API_RETCPOINTER(al_create_sample_instance(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE")),"ALLEGRO_SAMPLE_INSTANCE");
}
...
RING_FUNC(ring_al_destroy_sample_instance)
{
	...
	al_destroy_sample_instance(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"));
}
...
RING_FUNC(ring_al_play_sample_instance)
{
	...
	RING_API_RETNUMBER(al_play_sample_instance(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE")));
}
...
RING_FUNC(ring_al_stop_sample_instance)
{
	...
	RING_API_RETNUMBER(al_stop_sample_instance(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE")));
}
...
RING_FUNC(ring_al_get_sample_instance_channels)
{
	...
	}
	{
		ALLEGRO_CHANNEL_CONF *pValue ; 
		pValue = (ALLEGRO_CHANNEL_CONF *) malloc(sizeof(ALLEGRO_CHANNEL_CONF)) ;
		*pValue = al_get_sample_instance_channels(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_CHANNEL_CONF");
	}
}
...
RING_FUNC(ring_al_get_sample_instance_depth)
{
	...
	}
	{
		ALLEGRO_AUDIO_DEPTH *pValue ; 
		pValue = (ALLEGRO_AUDIO_DEPTH *) malloc(sizeof(ALLEGRO_AUDIO_DEPTH)) ;
		*pValue = al_get_sample_instance_depth(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_AUDIO_DEPTH");
	}
}
...
RING_FUNC(ring_al_get_sample_instance_frequency)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_sample_instance_frequency(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_get_sample_instance_length)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_sample_instance_length(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_set_sample_instance_length)
{
	...
	RING_API_RETNUMBER(al_set_sample_instance_length(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"),* (unsigned int  *) RING_API_GETCPOINTER(2,"unsigned int")));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"unsigned int"));
}
...
RING_FUNC(ring_al_get_sample_instance_position)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_sample_instance_position(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_set_sample_instance_position)
{
	...
	RING_API_RETNUMBER(al_set_sample_instance_position(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"),* (unsigned int  *) RING_API_GETCPOINTER(2,"unsigned int")));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"unsigned int"));
}
...
RING_FUNC(ring_al_get_sample_instance_speed)
{
	...
	RING_API_RETNUMBER(al_get_sample_instance_speed(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE")));
}
...
RING_FUNC(ring_al_set_sample_instance_speed)
{
	...
	RING_API_RETNUMBER(al_set_sample_instance_speed(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_sample_instance_gain)
{
	...
	RING_API_RETNUMBER(al_get_sample_instance_gain(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE")));
}
...
RING_FUNC(ring_al_set_sample_instance_gain)
{
	...
	RING_API_RETNUMBER(al_set_sample_instance_gain(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_sample_instance_pan)
{
	...
	RING_API_RETNUMBER(al_get_sample_instance_pan(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE")));
}
...
RING_FUNC(ring_al_set_sample_instance_pan)
{
	...
	RING_API_RETNUMBER(al_set_sample_instance_pan(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_sample_instance_time)
{
	...
	RING_API_RETNUMBER(al_get_sample_instance_time(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE")));
}
...
RING_FUNC(ring_al_get_sample_instance_playmode)
{
	...
	}
	{
		...
		pValue = (ALLEGRO_PLAYMODE *) malloc(sizeof(ALLEGRO_PLAYMODE)) ;
		*pValue = al_get_sample_instance_playmode(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"));
...
RING_FUNC(ring_al_set_sample_instance_playmode)
{
	...
	RING_API_RETNUMBER(al_set_sample_instance_playmode(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"),* (ALLEGRO_PLAYMODE  *) RING_API_GETCPOINTER(2,"ALLEGRO_PLAYMODE")));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_PLAYMODE"));
}
...
RING_FUNC(ring_al_get_sample_instance_playing)
{
	...
	RING_API_RETNUMBER(al_get_sample_instance_playing(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE")));
}
...
RING_FUNC(ring_al_set_sample_instance_playing)
{
	...
	RING_API_RETNUMBER(al_set_sample_instance_playing(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_sample_instance_attached)
{
	...
	RING_API_RETNUMBER(al_get_sample_instance_attached(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE")));
}
...
RING_FUNC(ring_al_detach_sample_instance)
{
	...
	RING_API_RETNUMBER(al_detach_sample_instance(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE")));
}
...
RING_FUNC(ring_al_get_sample)
{
	...
	RING_API_RETCPOINTER(al_get_sample(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE")),"ALLEGRO_SAMPLE");
}
...
RING_FUNC(ring_al_set_sample)
{
	...
	RING_API_RETNUMBER(al_set_sample(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"),RING_API_GETCPOINTER(2,"ALLEGRO_SAMPLE")));
}
...
RING_FUNC(ring_al_destroy_mixer)
{
	...
	al_destroy_mixer(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"));
}
...
RING_FUNC(ring_al_set_default_mixer)
{
	...
	RING_API_RETNUMBER(al_set_default_mixer(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER")));
}
...
RING_FUNC(ring_al_attach_mixer_to_mixer)
{
	...
	RING_API_RETNUMBER(al_attach_mixer_to_mixer(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"),RING_API_GETCPOINTER(2,"ALLEGRO_MIXER")));
}
...
RING_FUNC(ring_al_attach_sample_instance_to_mixer)
{
	...
	RING_API_RETNUMBER(al_attach_sample_instance_to_mixer(RING_API_GETCPOINTER(1,"ALLEGRO_SAMPLE_INSTANCE"),RING_API_GETCPOINTER(2,"ALLEGRO_MIXER")));
}
...
RING_FUNC(ring_al_attach_audio_stream_to_mixer)
{
	...
	RING_API_RETNUMBER(al_attach_audio_stream_to_mixer(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"),RING_API_GETCPOINTER(2,"ALLEGRO_MIXER")));
}
...
RING_FUNC(ring_al_get_mixer_frequency)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_mixer_frequency(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_set_mixer_frequency)
{
	...
	RING_API_RETNUMBER(al_set_mixer_frequency(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"),* (unsigned int  *) RING_API_GETCPOINTER(2,"unsigned int")));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"unsigned int"));
}
...
RING_FUNC(ring_al_get_mixer_channels)
{
	...
	}
	{
		ALLEGRO_CHANNEL_CONF *pValue ; 
		pValue = (ALLEGRO_CHANNEL_CONF *) malloc(sizeof(ALLEGRO_CHANNEL_CONF)) ;
		*pValue = al_get_mixer_channels(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_CHANNEL_CONF");
	}
}
...
RING_FUNC(ring_al_get_mixer_depth)
{
	...
	}
	{
		ALLEGRO_AUDIO_DEPTH *pValue ; 
		pValue = (ALLEGRO_AUDIO_DEPTH *) malloc(sizeof(ALLEGRO_AUDIO_DEPTH)) ;
		*pValue = al_get_mixer_depth(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_AUDIO_DEPTH");
	}
}
...
RING_FUNC(ring_al_get_mixer_gain)
{
	...
	RING_API_RETNUMBER(al_get_mixer_gain(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER")));
}
...
RING_FUNC(ring_al_set_mixer_gain)
{
	...
	RING_API_RETNUMBER(al_set_mixer_gain(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_mixer_quality)
{
	...
	}
	{
		...
		pValue = (ALLEGRO_MIXER_QUALITY *) malloc(sizeof(ALLEGRO_MIXER_QUALITY)) ;
		*pValue = al_get_mixer_quality(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"));
...
RING_FUNC(ring_al_set_mixer_quality)
{
	...
	RING_API_RETNUMBER(al_set_mixer_quality(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"),* (ALLEGRO_MIXER_QUALITY  *) RING_API_GETCPOINTER(2,"ALLEGRO_MIXER_QUALITY")));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_MIXER_QUALITY"));
}
...
RING_FUNC(ring_al_get_mixer_playing)
{
	...
	RING_API_RETNUMBER(al_get_mixer_playing(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER")));
}
...
RING_FUNC(ring_al_set_mixer_playing)
{
	...
	RING_API_RETNUMBER(al_set_mixer_playing(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_mixer_attached)
{
	...
	RING_API_RETNUMBER(al_get_mixer_attached(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER")));
}
...
RING_FUNC(ring_al_detach_mixer)
{
	...
	RING_API_RETNUMBER(al_detach_mixer(RING_API_GETCPOINTER(1,"ALLEGRO_MIXER")));
}
...
RING_FUNC(ring_al_create_audio_stream)
{
	...
	RING_API_RETCPOINTER(al_create_audio_stream(RING_API_GETNUMBER(1),* (unsigned int  *) RING_API_GETCPOINTER(2,"unsigned int"),* (unsigned int  *) RING_API_GETCPOINTER(3,"unsigned int"),* (ALLEGRO_AUDIO_DEPTH  *) RING_API_GETCPOINTER(4,"ALLEGRO_AUDIO_DEPTH"),* (ALLEGRO_CHANNEL_CONF  *) RING_API_GETCPOINTER(5,"ALLEGRO_CHANNEL_CONF")),"ALLEGRO_AUDIO_STREAM");
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"unsigned int"));
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"unsigned int"));
...
RING_FUNC(ring_al_destroy_audio_stream)
{
	...
	al_destroy_audio_stream(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"));
}
...
RING_FUNC(ring_al_get_audio_stream_event_source)
{
	...
	RING_API_RETCPOINTER(al_get_audio_stream_event_source(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")),"ALLEGRO_EVENT_SOURCE");
}
...
RING_FUNC(ring_al_drain_audio_stream)
{
	...
	al_drain_audio_stream(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"));
}
...
RING_FUNC(ring_al_rewind_audio_stream)
{
	...
	RING_API_RETNUMBER(al_rewind_audio_stream(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")));
}
...
RING_FUNC(ring_al_get_audio_stream_frequency)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_audio_stream_frequency(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_get_audio_stream_channels)
{
	...
	}
	{
		ALLEGRO_CHANNEL_CONF *pValue ; 
		pValue = (ALLEGRO_CHANNEL_CONF *) malloc(sizeof(ALLEGRO_CHANNEL_CONF)) ;
		*pValue = al_get_audio_stream_channels(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_CHANNEL_CONF");
	}
}
...
RING_FUNC(ring_al_get_audio_stream_depth)
{
	...
	}
	{
		ALLEGRO_AUDIO_DEPTH *pValue ; 
		pValue = (ALLEGRO_AUDIO_DEPTH *) malloc(sizeof(ALLEGRO_AUDIO_DEPTH)) ;
		*pValue = al_get_audio_stream_depth(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_AUDIO_DEPTH");
	}
}
...
RING_FUNC(ring_al_get_audio_stream_length)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_audio_stream_length(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_get_audio_stream_speed)
{
	...
	RING_API_RETNUMBER(al_get_audio_stream_speed(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")));
}
...
RING_FUNC(ring_al_set_audio_stream_speed)
{
	...
	RING_API_RETNUMBER(al_set_audio_stream_speed(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_audio_stream_gain)
{
	...
	RING_API_RETNUMBER(al_get_audio_stream_gain(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")));
}
...
RING_FUNC(ring_al_set_audio_stream_gain)
{
	...
	RING_API_RETNUMBER(al_set_audio_stream_gain(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_audio_stream_pan)
{
	...
	RING_API_RETNUMBER(al_get_audio_stream_pan(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")));
}
...
RING_FUNC(ring_al_set_audio_stream_pan)
{
	...
	RING_API_RETNUMBER(al_set_audio_stream_pan(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_audio_stream_playing)
{
	...
	RING_API_RETNUMBER(al_get_audio_stream_playing(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")));
}
...
RING_FUNC(ring_al_set_audio_stream_playing)
{
	...
	RING_API_RETNUMBER(al_set_audio_stream_playing(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_audio_stream_playmode)
{
	...
	}
	{
		ALLEGRO_PLAYMODE *pValue ; 
		pValue = (ALLEGRO_PLAYMODE *) malloc(sizeof(ALLEGRO_PLAYMODE)) ;
		*pValue = al_get_audio_stream_playmode(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_PLAYMODE");
	}
}
...
RING_FUNC(ring_al_set_audio_stream_playmode)
{
	...
	RING_API_RETNUMBER(al_set_audio_stream_playmode(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"),* (ALLEGRO_PLAYMODE  *) RING_API_GETCPOINTER(2,"ALLEGRO_PLAYMODE")));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_PLAYMODE"));
}
...
RING_FUNC(ring_al_get_audio_stream_attached)
{
	...
	RING_API_RETNUMBER(al_get_audio_stream_attached(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")));
}
...
RING_FUNC(ring_al_detach_audio_stream)
{
	...
	RING_API_RETNUMBER(al_detach_audio_stream(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")));
}
...
RING_FUNC(ring_al_get_audio_stream_fragment)
{
	...
	RING_API_RETCPOINTER(al_get_audio_stream_fragment(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")),"void");
}
...
RING_FUNC(ring_al_set_audio_stream_fragment)
{
	...
	RING_API_RETNUMBER(al_set_audio_stream_fragment(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"),RING_API_GETCPOINTER(2,"void")));
}
...
RING_FUNC(ring_al_get_audio_stream_fragments)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_audio_stream_fragments(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_get_available_audio_stream_fragments)
{
	...
	}
	{
		unsigned int *pValue ; 
		pValue = (unsigned int *) malloc(sizeof(unsigned int)) ;
		*pValue = al_get_available_audio_stream_fragments(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"));
		RING_API_RETCPOINTER(pValue,"unsigned int");
	}
}
...
RING_FUNC(ring_al_seek_audio_stream_secs)
{
	...
	RING_API_RETNUMBER(al_seek_audio_stream_secs(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_get_audio_stream_position_secs)
{
	...
	RING_API_RETNUMBER(al_get_audio_stream_position_secs(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")));
}
...
RING_FUNC(ring_al_get_audio_stream_length_secs)
{
	...
	RING_API_RETNUMBER(al_get_audio_stream_length_secs(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM")));
}
...
RING_FUNC(ring_al_set_audio_stream_loop_secs)
{
	...
	RING_API_RETNUMBER(al_set_audio_stream_loop_secs(RING_API_GETCPOINTER(1,"ALLEGRO_AUDIO_STREAM"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_load_sample_f)
{
	...
	RING_API_RETCPOINTER(al_load_sample_f(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETSTRING(2)),"ALLEGRO_SAMPLE");
}
...
RING_FUNC(ring_al_load_audio_stream)
{
	...
	RING_API_RETCPOINTER(al_load_audio_stream(RING_API_GETSTRING(1),RING_API_GETNUMBER(2),* (unsigned int  *) RING_API_GETCPOINTER(3,"unsigned int")),"ALLEGRO_AUDIO_STREAM");
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"unsigned int"));
}
...
RING_FUNC(ring_al_load_audio_stream_f)
{
	...
	RING_API_RETCPOINTER(al_load_audio_stream_f(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETSTRING(2),RING_API_GETNUMBER(3),* (unsigned int  *) RING_API_GETCPOINTER(4,"unsigned int")),"ALLEGRO_AUDIO_STREAM");
	if (RING_API_ISCPOINTERNOTASSIGNED(4))
		free(RING_API_GETCPOINTER(4,"unsigned int"));
}
...
RING_FUNC(ring_al_save_sample)
{
	...
	RING_API_RETNUMBER(al_save_sample(RING_API_GETSTRING(1),RING_API_GETCPOINTER(2,"ALLEGRO_SAMPLE")));
}
...
RING_FUNC(ring_al_save_sample_f)
{
	...
	RING_API_RETNUMBER(al_save_sample_f(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETSTRING(2),RING_API_GETCPOINTER(3,"ALLEGRO_SAMPLE")));
}
...
RING_FUNC(ring_al_color_cmyk)
{
	...
	}
	{
		ALLEGRO_COLOR *pValue ; 
		pValue = (ALLEGRO_COLOR *) malloc(sizeof(ALLEGRO_COLOR)) ;
		*pValue = al_color_cmyk(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_COLOR");
	}
}
...
RING_FUNC(ring_al_color_cmyk_to_rgb)
{
	...
	al_color_cmyk_to_rgb(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETCPOINTER(5,"float"),RING_API_GETCPOINTER(6,"float"),RING_API_GETCPOINTER(7,"float"));
}
...
RING_FUNC(ring_al_color_hsl)
{
	...
	}
	{
		ALLEGRO_COLOR *pValue ; 
		pValue = (ALLEGRO_COLOR *) malloc(sizeof(ALLEGRO_COLOR)) ;
		*pValue = al_color_hsl(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_COLOR");
	}
}
...
RING_FUNC(ring_al_color_hsl_to_rgb)
{
	...
	al_color_hsl_to_rgb(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETCPOINTER(4,"float"),RING_API_GETCPOINTER(5,"float"),RING_API_GETCPOINTER(6,"float"));
}
...
RING_FUNC(ring_al_color_hsv)
{
	...
	}
	{
		ALLEGRO_COLOR *pValue ; 
		pValue = (ALLEGRO_COLOR *) malloc(sizeof(ALLEGRO_COLOR)) ;
		*pValue = al_color_hsv(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_COLOR");
	}
}
...
RING_FUNC(ring_al_color_hsv_to_rgb)
{
	...
	al_color_hsv_to_rgb(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETCPOINTER(4,"float"),RING_API_GETCPOINTER(5,"float"),RING_API_GETCPOINTER(6,"float"));
}
...
RING_FUNC(ring_al_color_html_to_rgb)
{
	...
	al_color_html_to_rgb(RING_API_GETSTRING(1),RING_API_GETCPOINTER(2,"float"),RING_API_GETCPOINTER(3,"float"),RING_API_GETCPOINTER(4,"float"));
}
...
RING_FUNC(ring_al_color_rgb_to_html)
{
	...
	al_color_rgb_to_html(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETCPOINTER(4,"char"));
}
...
RING_FUNC(ring_al_color_name_to_rgb)
{
	...
	RING_API_RETNUMBER(al_color_name_to_rgb(RING_API_GETSTRING(1),RING_API_GETCPOINTER(2,"float"),RING_API_GETCPOINTER(3,"float"),RING_API_GETCPOINTER(4,"float")));
}
...
RING_FUNC(ring_al_color_rgb_to_cmyk)
{
	...
	al_color_rgb_to_cmyk(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETCPOINTER(4,"float"),RING_API_GETCPOINTER(5,"float"),RING_API_GETCPOINTER(6,"float"),RING_API_GETCPOINTER(7,"float"));
}
...
RING_FUNC(ring_al_color_rgb_to_hsl)
{
	...
	al_color_rgb_to_hsl(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETCPOINTER(4,"float"),RING_API_GETCPOINTER(5,"float"),RING_API_GETCPOINTER(6,"float"));
}
...
RING_FUNC(ring_al_color_rgb_to_hsv)
{
	...
	al_color_rgb_to_hsv(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETCPOINTER(4,"float"),RING_API_GETCPOINTER(5,"float"),RING_API_GETCPOINTER(6,"float"));
}
...
RING_FUNC(ring_al_color_rgb_to_name)
{
	...
	RING_API_RETSTRING(al_color_rgb_to_name(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)));
}
...
RING_FUNC(ring_al_color_rgb_to_yuv)
{
	...
	al_color_rgb_to_yuv(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETCPOINTER(4,"float"),RING_API_GETCPOINTER(5,"float"),RING_API_GETCPOINTER(6,"float"));
}
...
RING_FUNC(ring_al_color_yuv)
{
	...
	}
	{
		ALLEGRO_COLOR *pValue ; 
		pValue = (ALLEGRO_COLOR *) malloc(sizeof(ALLEGRO_COLOR)) ;
		*pValue = al_color_yuv(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3));
		RING_API_RETCPOINTER(pValue,"ALLEGRO_COLOR");
	}
}
...
RING_FUNC(ring_al_color_yuv_to_rgb)
{
	...
	al_color_yuv_to_rgb(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETCPOINTER(4,"float"),RING_API_GETCPOINTER(5,"float"),RING_API_GETCPOINTER(6,"float"));
}
...
RING_FUNC(ring_al_load_font)
{
	...
	RING_API_RETCPOINTER(al_load_font(RING_API_GETSTRING(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)),"ALLEGRO_FONT");
}
...
RING_FUNC(ring_al_destroy_font)
{
	...
	al_destroy_font(RING_API_GETCPOINTER(1,"ALLEGRO_FONT"));
}


RING_FUNC(ring_al_register_font_loader)
{
	if ( RING_API_PARACOUNT != 4 ) {
		RING_API_ERROR(RING_API_MISS4PARA);
		return ;
	...
	RING_API_RETNUMBER(al_register_font_loader(RING_API_GETSTRING(1),RING_API_GETCPOINTER(2,"ALLEGRO_FONT (load_font)(char"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4)));
}
...
RING_FUNC(ring_al_get_font_line_height)
{
	...
	RING_API_RETNUMBER(al_get_font_line_height(RING_API_GETCPOINTER(1,"ALLEGRO_FONT")));
}
...
RING_FUNC(ring_al_get_font_ascent)
{
	...
	RING_API_RETNUMBER(al_get_font_ascent(RING_API_GETCPOINTER(1,"ALLEGRO_FONT")));
}
...
RING_FUNC(ring_al_get_font_descent)
{
	...
	RING_API_RETNUMBER(al_get_font_descent(RING_API_GETCPOINTER(1,"ALLEGRO_FONT")));
}
...
RING_FUNC(ring_al_get_text_width)
{
	...
	RING_API_RETNUMBER(al_get_text_width(RING_API_GETCPOINTER(1,"ALLEGRO_FONT"),RING_API_GETSTRING(2)));
}
...
RING_FUNC(ring_al_get_ustr_width)
{
	...
	RING_API_RETNUMBER(al_get_ustr_width(RING_API_GETCPOINTER(1,"ALLEGRO_FONT"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR")));
}
...
RING_FUNC(ring_al_draw_text)
{
	...
	al_draw_text(RING_API_GETCPOINTER(1,"ALLEGRO_FONT"),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETSTRING(6));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_ustr)
{
	...
	al_draw_ustr(RING_API_GETCPOINTER(1,"ALLEGRO_FONT"),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETCPOINTER(6,"ALLEGRO_USTR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_justified_text)
{
	...
	al_draw_justified_text(RING_API_GETCPOINTER(1,"ALLEGRO_FONT"),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7),RING_API_GETSTRING(8));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_justified_ustr)
{
	...
	al_draw_justified_ustr(RING_API_GETCPOINTER(1,"ALLEGRO_FONT"),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7),RING_API_GETCPOINTER(8,"ALLEGRO_USTR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_get_text_dimensions)
{
	...
	al_get_text_dimensions(RING_API_GETCPOINTER(1,"ALLEGRO_FONT"),RING_API_GETSTRING(2),RING_API_GETINTPOINTER(3),RING_API_GETINTPOINTER(4),RING_API_GETINTPOINTER(5),RING_API_GETINTPOINTER(6));
	RING_API_ACCEPTINTVALUE(3) ;
	RING_API_ACCEPTINTVALUE(4) ;
	RING_API_ACCEPTINTVALUE(5) ;
	RING_API_ACCEPTINTVALUE(6) ;
...
RING_FUNC(ring_al_get_ustr_dimensions)
{
	...
	al_get_ustr_dimensions(RING_API_GETCPOINTER(1,"ALLEGRO_FONT"),RING_API_GETCPOINTER(2,"ALLEGRO_USTR"),RING_API_GETINTPOINTER(3),RING_API_GETINTPOINTER(4),RING_API_GETINTPOINTER(5),RING_API_GETINTPOINTER(6));
	RING_API_ACCEPTINTVALUE(3) ;
	RING_API_ACCEPTINTVALUE(4) ;
	RING_API_ACCEPTINTVALUE(5) ;
	RING_API_ACCEPTINTVALUE(6) ;
...
RING_FUNC(ring_al_grab_font_from_bitmap)
{
	...
	RING_API_RETCPOINTER(al_grab_font_from_bitmap(RING_API_GETCPOINTER(1,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(2),* (const int  *) RING_API_GETCPOINTER(3,"const int")),"ALLEGRO_FONT");
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"int"));
}
...
RING_FUNC(ring_al_load_ttf_font)
{
	...
	RING_API_RETCPOINTER(al_load_ttf_font(RING_API_GETSTRING(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3)),"ALLEGRO_FONT");
}
...
RING_FUNC(ring_al_load_ttf_font_f)
{
	...
	RING_API_RETCPOINTER(al_load_ttf_font_f(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETSTRING(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4)),"ALLEGRO_FONT");
}
...
RING_FUNC(ring_al_load_ttf_font_stretch)
{
	...
	RING_API_RETCPOINTER(al_load_ttf_font_stretch(RING_API_GETSTRING(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4)),"ALLEGRO_FONT");
}
...
RING_FUNC(ring_al_load_ttf_font_stretch_f)
{
	...
	RING_API_RETCPOINTER(al_load_ttf_font_stretch_f(RING_API_GETCPOINTER(1,"ALLEGRO_FILE"),RING_API_GETSTRING(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5)),"ALLEGRO_FONT");
}
...
RING_FUNC(ring_al_open_memfile)
{
	...
	RING_API_RETCPOINTER(al_open_memfile(RING_API_GETCPOINTER(1,"void"),RING_API_GETNUMBER(2),RING_API_GETSTRING(3)),"ALLEGRO_FILE");
}
...
RING_FUNC(ring_al_create_native_file_dialog)
{
	...
	RING_API_RETCPOINTER(al_create_native_file_dialog(RING_API_GETSTRING(1),RING_API_GETSTRING(2),RING_API_GETSTRING(3),RING_API_GETNUMBER(4)),"ALLEGRO_FILECHOOSER");
}
...
RING_FUNC(ring_al_show_native_file_dialog)
{
	...
	RING_API_RETNUMBER(al_show_native_file_dialog(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETCPOINTER(2,"ALLEGRO_FILECHOOSER")));
}
...
RING_FUNC(ring_al_get_native_file_dialog_count)
{
	...
	RING_API_RETNUMBER(al_get_native_file_dialog_count(RING_API_GETCPOINTER(1,"ALLEGRO_FILECHOOSER")));
}
...
RING_FUNC(ring_al_get_native_file_dialog_path)
{
	...
	RING_API_RETSTRING(al_get_native_file_dialog_path(RING_API_GETCPOINTER(1,"ALLEGRO_FILECHOOSER"),RING_API_GETNUMBER(2)));
}
...
RING_FUNC(ring_al_destroy_native_file_dialog)
{
	...
	al_destroy_native_file_dialog(RING_API_GETCPOINTER(1,"ALLEGRO_FILECHOOSER"));
}
...
RING_FUNC(ring_al_show_native_message_box)
{
	...
	RING_API_RETNUMBER(al_show_native_message_box(RING_API_GETCPOINTER(1,"ALLEGRO_DISPLAY"),RING_API_GETSTRING(2),RING_API_GETSTRING(3),RING_API_GETSTRING(4),RING_API_GETSTRING(5),RING_API_GETNUMBER(6)));
}
...
RING_FUNC(ring_al_open_native_text_log)
{
	...
	RING_API_RETCPOINTER(al_open_native_text_log(RING_API_GETSTRING(1),RING_API_GETNUMBER(2)),"ALLEGRO_TEXTLOG");
}
...
RING_FUNC(ring_al_close_native_text_log)
{
	...
	al_close_native_text_log(RING_API_GETCPOINTER(1,"ALLEGRO_TEXTLOG"));
}
...
RING_FUNC(ring_al_get_native_text_log_event_source)
{
	...
	RING_API_RETCPOINTER(al_get_native_text_log_event_source(RING_API_GETCPOINTER(1,"ALLEGRO_TEXTLOG")),"ALLEGRO_EVENT_SOURCE");
}
...
RING_FUNC(ring_al_draw_line)
{
	...
	al_draw_line(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(5,"ALLEGRO_COLOR"),RING_API_GETNUMBER(6));
	if (RING_API_ISCPOINTERNOTASSIGNED(5))
		free(RING_API_GETCPOINTER(5,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_triangle)
{
	...
	al_draw_triangle(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(7,"ALLEGRO_COLOR"),RING_API_GETNUMBER(8));
	if (RING_API_ISCPOINTERNOTASSIGNED(7))
		free(RING_API_GETCPOINTER(7,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_filled_triangle)
{
	...
	al_draw_filled_triangle(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(7,"ALLEGRO_COLOR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(7))
		free(RING_API_GETCPOINTER(7,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_rectangle)
{
	...
	al_draw_rectangle(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(5,"ALLEGRO_COLOR"),RING_API_GETNUMBER(6));
	if (RING_API_ISCPOINTERNOTASSIGNED(5))
		free(RING_API_GETCPOINTER(5,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_filled_rectangle)
{
	...
	al_draw_filled_rectangle(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(5,"ALLEGRO_COLOR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(5))
		free(RING_API_GETCPOINTER(5,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_rounded_rectangle)
{
	...
	al_draw_rounded_rectangle(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(7,"ALLEGRO_COLOR"),RING_API_GETNUMBER(8));
	if (RING_API_ISCPOINTERNOTASSIGNED(7))
		free(RING_API_GETCPOINTER(7,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_filled_rounded_rectangle)
{
	...
	al_draw_filled_rounded_rectangle(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(7,"ALLEGRO_COLOR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(7))
		free(RING_API_GETCPOINTER(7,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_calculate_arc)
{
	...
	al_calculate_arc(RING_API_GETCPOINTER(1,"float"),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),RING_API_GETNUMBER(7),RING_API_GETNUMBER(8),RING_API_GETNUMBER(9),RING_API_GETNUMBER(10));
}
...
RING_FUNC(ring_al_draw_pieslice)
{
	...
	al_draw_pieslice(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(6,"ALLEGRO_COLOR"),RING_API_GETNUMBER(7));
	if (RING_API_ISCPOINTERNOTASSIGNED(6))
		free(RING_API_GETCPOINTER(6,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_filled_pieslice)
{
	...
	al_draw_filled_pieslice(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(6,"ALLEGRO_COLOR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(6))
		free(RING_API_GETCPOINTER(6,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_ellipse)
{
	...
	al_draw_ellipse(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(5,"ALLEGRO_COLOR"),RING_API_GETNUMBER(6));
	if (RING_API_ISCPOINTERNOTASSIGNED(5))
		free(RING_API_GETCPOINTER(5,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_filled_ellipse)
{
	...
	al_draw_filled_ellipse(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(5,"ALLEGRO_COLOR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(5))
		free(RING_API_GETCPOINTER(5,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_circle)
{
	...
	al_draw_circle(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(4,"ALLEGRO_COLOR"),RING_API_GETNUMBER(5));
	if (RING_API_ISCPOINTERNOTASSIGNED(4))
		free(RING_API_GETCPOINTER(4,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_filled_circle)
{
	...
	al_draw_filled_circle(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(4,"ALLEGRO_COLOR"));
	if (RING_API_ISCPOINTERNOTASSIGNED(4))
		free(RING_API_GETCPOINTER(4,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_arc)
{
	...
	al_draw_arc(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(6,"ALLEGRO_COLOR"),RING_API_GETNUMBER(7));
	if (RING_API_ISCPOINTERNOTASSIGNED(6))
		free(RING_API_GETCPOINTER(6,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_elliptical_arc)
{
	...
	al_draw_elliptical_arc(RING_API_GETNUMBER(1),RING_API_GETNUMBER(2),RING_API_GETNUMBER(3),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(7,"ALLEGRO_COLOR"),RING_API_GETNUMBER(8));
	if (RING_API_ISCPOINTERNOTASSIGNED(7))
		free(RING_API_GETCPOINTER(7,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_calculate_ribbon)
{
	...
	al_calculate_ribbon(RING_API_GETCPOINTER(1,"float"),RING_API_GETNUMBER(2),RING_API_GETCPOINTER(3,"float"),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6));
}
...
RING_FUNC(ring_al_draw_ribbon)
{
	...
	al_draw_ribbon(RING_API_GETCPOINTER(1,"float"),RING_API_GETNUMBER(2),* (ALLEGRO_COLOR  *) RING_API_GETCPOINTER(3,"ALLEGRO_COLOR"),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5));
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"ALLEGRO_COLOR"));
}
...
RING_FUNC(ring_al_draw_prim)
{
	...
	RING_API_RETNUMBER(al_draw_prim(RING_API_GETCPOINTER(1,"void"),RING_API_GETCPOINTER(2,"ALLEGRO_VERTEX_DECL"),RING_API_GETCPOINTER(3,"ALLEGRO_BITMAP"),RING_API_GETNUMBER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6)));
}
...
RING_FUNC(ring_al_draw_indexed_prim)
{
	...
	RING_API_RETNUMBER(al_draw_indexed_prim(RING_API_GETCPOINTER(1,"void"),RING_API_GETCPOINTER(2,"ALLEGRO_VERTEX_DECL"),RING_API_GETCPOINTER(3,"ALLEGRO_BITMAP"),RING_API_GETINTPOINTER(4),RING_API_GETNUMBER(5),RING_API_GETNUMBER(6)));
	RING_API_ACCEPTINTVALUE(4) ;
}
...
RING_FUNC(ring_al_create_vertex_decl)
{
	...
	RING_API_RETCPOINTER(al_create_vertex_decl(RING_API_GETCPOINTER(1,"ALLEGRO_VERTEX_ELEMENT"),RING_API_GETNUMBER(2)),"ALLEGRO_VERTEX_DECL");
}
...
RING_FUNC(ring_al_destroy_vertex_decl)
{
	...
	al_destroy_vertex_decl(RING_API_GETCPOINTER(1,"ALLEGRO_VERTEX_DECL"));
}
...
RING_DLL void ringlib_init(RingState *pRingState)
{
	...
	ring_vm_funcregister("al_emit_user_event",ring_al_emit_user_event);
	...
	ring_vm_funcregister("al_utf16_encode",ring_al_utf16_encode);
	...
	ring_vm_funcregister("al_register_font_loader",ring_al_register_font_loader);
