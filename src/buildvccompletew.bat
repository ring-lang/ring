...
ring_vmodbc.c ring_vmmysql.c ring_vmopenssl.c ring_vmcurl.c ring_ext.c ring_vmdll.c ring_vmsqlite.c sqlite3.c -I"..\include" -I"..\libdepwin\libcurl\include" -I"..\libdepwin\openssl\include" -I"..\libdepwin\mysql\include" 
...
ring_vmodbc.obj ring_vmmysql.obj ring_vmopenssl.obj ring_vmcurl.obj ring_ext.obj ring_vmdll.obj ring_vmsqlite.obj sqlite3.obj ..\libdepwin\libcurl\lib\libcurl.lib "..\libdepwin\mysql\lib\libmysql.lib" ..\libdepwin\openssl\lib\libeay32.lib odbc32.lib
