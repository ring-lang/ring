...
ring_vmodbc.c ..\extensions\ringmysql\ring_vmmysql.c ..\extensions\ringopenssl\ring_vmopenssl.c ..\extensions\ringcurl\ring_vmcurl.c ring_ext.c ring_vmdll.c ..\extensions\ringsqlite\ring_vmsqlite.c ..\extensions\ringsqlite\sqlite3.c ring_objfile.c -I"..\include" -I"..\libdepwin\libcurl\include" -I"..\libdepwin\openssl\include" -I"..\libdepwin\mysql\include" 
