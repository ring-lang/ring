...
ring_vmodbc.c ring_vmmysql.c ring_vmopenssl.c ring_vmcurl.c ring_ext.c ring_vmdll.c ring_vmsqlite.c sqlite3.c ring_objfile.c -I"..\include" -I"..\libdepwin\libcurl\include" -I"..\libdepwin\openssl\include" -I"..\libdepwin\mysql\include" 
