...
<table>
	...
	<tr>
		...
		<td>
			...
			ايضا نتعرف على كيفية انشاء ملف EXE للتطبيق الخاص بنا من خلال الاداة Ring2EXE التى تأتى مع لغة الرينج 
		</td>
		<td>
	...
	<tr>
		<td>8</td>
		<td>
			نتعرف على الدالة Eval وكيفية استخدام لتنفيذ كود مكتوب فى عبارة حرفية وقت التشغيل وكيفية استغلال تلك الميزة لعمل RingREPL وندرس ايضا كيفية استخدام Return
