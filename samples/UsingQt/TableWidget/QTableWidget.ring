...
func pEdit 
	...
	lineedit1 { row = numorzero(text())}
	lineedit2 { column = numorzero(text())}
	Table1.setfocus(true)
...
func setHeight 
	...
	Table1 { 
		lineedit3 { setRow = numorzero(text())}
		lineedit4 { setHeight = numorzero(text())}
...
func setWidth 
	...
	Table1 { 
		lineedit5 { setColumn = numorzero(text())}
		lineedit6 { setWidth = numorzero(text())}
