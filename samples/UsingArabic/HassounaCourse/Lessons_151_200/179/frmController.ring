...
class frmController from windowsControllerParent
	...
	func btnGetCurrent_Click()
		strCur = oView.combobox1.CurrentText() + ";" + oView.combobox1.CurrentIndex()
		t.msgBox(strCur)

	func Combobox1_CurrentIndexChanged()
		oView.lblCurrent.SetText( oView.combobox1.CurrentText() )
