...
class my_site
	func start()
		...
		new bootstrapPage{
			...
			if aPageVars['btnok1']!=null
				html('<h1>You clicked on Test 1</h1>')
			ok

			if aPageVars['btnok2']!=null
				html('<h1>You clicked on Test 2</h1>')
			ok

			if aPageVars['btnok3']!=null
				html('<h1>You clicked on Test 3</h1>')
			ok
