...
class frmView from WindowsViewParent
	win = new MainWindow() { 
		...
		Button14 = new pushbutton(win) {
			...
			oFont.delete()
			setText("C")
			setClickEvent(Method(:getCount))
			setBtnImage(Button14,"")
			
		}
		txtTabName = new lineedit(win) {
			move(770,9)
			resize(55,25)
			setstylesheet("color:black;background-color:white;")
			oFont = new qfont("",0,0,0)
