...
gcc -shared -o $PWD/../../lib/libring.so general.o state.o ext.o hashlib.o rhtable.o vmgc.o os_e.o rstring.o rlist.o ritem.o ritems.o scanner.o parser.o stmt.o expr.o codegen.o vm.o vmerror.o vmeval.o vmthread.o vmexpr.o vmvars.o vmlists.o vmfuncs.o ringapi.o vmoop.o  vmtry.o vmstr.o vmjump.o vmrange.o list_e.o meta_e.o vmperf.o vmexit.o vmstack.o vmstate.o genlib_e.o math_e.o file_e.o dll_e.o  objfile.o -lm -ldl  

ar rcs $PWD/../../lib/libringstatic.a general.o state.o ext.o hashlib.o rhtable.o vmgc.o os_e.o rstring.o rlist.o ritem.o ritems.o scanner.o parser.o stmt.o expr.o codegen.o vm.o vmerror.o vmeval.o vmthread.o vmexpr.o vmvars.o vmlists.o vmfuncs.o ringapi.o vmoop.o  vmtry.o vmstr.o vmjump.o vmrange.o list_e.o meta_e.o vmperf.o vmexit.o vmstack.o vmstate.o genlib_e.o math_e.o file_e.o dll_e.o  objfile.o
