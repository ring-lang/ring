...
ring_vmperformance.obj ring_vmexit.obj ring_vmstackvars.obj ring_vmstate.obj ring_vmgenerallib.obj ring_vmmath.obj ring_vmfile.obj ring_os_extension.obj ring_vmlistfuncs.obj ring_refmeta_extension.obj ^
