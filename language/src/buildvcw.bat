...
ring_vmperformance.c ring_vmexit.c ring_vmstackvars.c ring_vmstate.c ring_vmgenerallib.c ring_vmmath.c ring_vmfile.c ring_os_extension.c ring_vmlistfuncs.c ring_vmrefmeta.c ^
...
ring_vmperformance.obj ring_vmexit.obj ring_vmstackvars.obj ring_vmstate.obj ring_vmgenerallib.obj ring_vmmath.obj ring_vmfile.obj ring_os_extension.obj ring_vmlistfuncs.obj ring_vmrefmeta.obj ^
