...
#define RING_VAR_SETSTRING2_GC(pState, pVar, cStr, nSize)                                                              \
	ring_string_set2_gc(pState, RING_VAR_GETSTRINGOBJ(pVar), cStr, nSize)
...
#define RING_VAR_SETPOINTER(pVar, ptr) (RING_VAR_ITEMS_VALUE(pVar)->pValue->data.pPointer = (ptr))
...
#define RING_VAR_SETNUMBER(pVar, n) (RING_VAR_ITEMS_VALUE(pVar)->pValue->data.dNumber = (n))
