...
aTests = [
	...
	[ :name = "Power Operator (Part 1)", :Command = "ring general/powoperator.ring" ],
	[ :name = "Power Operator (Part 2)", :Command = "ring general/powoperator2.ring" ],
	[ :name = "Using References (Part 1)", :Command = "ring general/pointer.ring" ],
	[ :name = "Using References (Part 2)", :Command = "ring general/pointer2.ring" ],
	[ :name = "Using References (Part 3)", :Command = "ring general/tree.ring" ],
	[ :name = "Using References (Part 4)", :Command = "ring general/tree2.ring" ],
	[ :name = "Using References (Part 5)", :Command = "ring general/tree3.ring" ],
	[ :name = "Using References (Part 6)", :Command = "ring general/depinj.ring" ],
	[ :name = "Using References (Part 7)", :Command = "ring general/selfdel.ring" ],
	[ :name = "Using References (Part 8)", :Command = "ring general/selfdel2.ring" ],
	[ :name = "Using References (Part 9)", :Command = "ring general/selfdel3.ring" ],
	[ :name = "Using References (Part 10)", :Command = "ring general/selfdel4.ring" ],
	[ :name = "Using References (Part 11)", :Command = "ring general/cycle.ring" ],
	[ :name = "Using References (Part 12)", :Command = "ring general/cycle2.ring" ],
	[ :name = "Using References (Part 13)", :Command = "ring general/refequalitself.ring" ],
	[ :name = "Using References (Part 14)", :Command = "ring general/refequalitself2.ring" ]
]
