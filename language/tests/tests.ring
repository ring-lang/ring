...
aTests = [
	...
	[ :name = "General Tests (Part 93)", :Command = "ring general/test93.ring" ],
	...
	[ :name = "General Tests (Part 123)", :Command = "ring general/test123.ring" ],
	...
	[ :name = "Exit and Loop (Part 1)", :Command = "ring general/exitandloop/test1.ring" ],
	[ :name = "Exit and Loop (Part 2)", :Command = "ring general/exitandloop/test2.ring" ],
	[ :name = "Exit and Loop (Part 3)", :Command = "ring general/exitandloop/test3.ring" ],
	[ :name = "Exit and Loop (Part 4)", :Command = "ring general/exitandloop/test4.ring" ]
]
