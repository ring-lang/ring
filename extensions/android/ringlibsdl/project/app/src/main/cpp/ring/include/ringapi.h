...
#define RING_VARVALUE_LONGINT 6
#define RING_VARVALUE_UNSIGNEDLONGINT 7
#define RING_VARVALUE_CHAR 8
#define RING_VARVALUE_SIGNEDCHAR 9
#define RING_VARVALUE_UNSIGNEDCHAR 10
