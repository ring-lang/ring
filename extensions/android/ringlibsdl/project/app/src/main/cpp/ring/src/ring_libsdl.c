...
RING_FUNC(ring_SDL_GL_BindTexture)
{
	...
	RING_API_RETNUMBER(SDL_GL_BindTexture((SDL_Texture *) RING_API_GETCPOINTER(1,"SDL_Texture"),RING_API_GETFLOATPOINTER(2),RING_API_GETFLOATPOINTER(3)));
...
RING_FUNC(ring_SDL_RenderGetScale)
{
	...
	SDL_RenderGetScale((SDL_Renderer *) RING_API_GETCPOINTER(1,"SDL_Renderer"),RING_API_GETFLOATPOINTER(2),RING_API_GETFLOATPOINTER(3));
	RING_API_ACCEPTFLOATVALUE(2) ;
	RING_API_ACCEPTFLOATVALUE(3) ;
}
