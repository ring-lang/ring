...
#define RING_VARVALUE_CHAR 1
#define RING_VARVALUE_SIGNEDCHAR 2
#define RING_VARVALUE_UNSIGNEDCHAR 3
#define RING_VARVALUE_SHORTINT 4
#define RING_VARVALUE_UNSIGNEDSHORTINT 5
#define RING_VARVALUE_INT 6
#define RING_VARVALUE_UNSIGNEDINT 7
#define RING_VARVALUE_LONGINT 8
#define RING_VARVALUE_UNSIGNEDLONGINT 9
#define RING_VARVALUE_FLOAT 10
#define RING_VARVALUE_DOUBLE 11
