...
static void *ringtheads_mutex_create(void) {
	return custom_mtx_init();
}

static void ringtheads_mutex_lock(void *mutex) {
	mtx_lock((mtx_t *) mutex);
}

static void ringtheads_mutex_unlock(void *mutex) {
	mtx_unlock((mtx_t *) mutex);
}

static void ringtheads_mutex_destroy(void *mutex) {
...
RING_FUNC(ring_thrd_create)
{
	...
	ring_vm_mutexfunctions((VM *) pPointer,ringtheads_mutex_create,ringtheads_mutex_lock,ringtheads_mutex_unlock,ringtheads_mutex_destroy);
