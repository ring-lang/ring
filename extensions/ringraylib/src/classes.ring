...
class Camera 
	...
	func setdata oStruct 
		position.x = raylib_get_Camera_position_x(oStruct)
		position.y = raylib_get_Camera_position_y(oStruct)
		position.z = raylib_get_Camera_position_z(oStruct)
		target.x = raylib_get_Camera_target_x(oStruct)
		target.y = raylib_get_Camera_target_y(oStruct)
		target.z = raylib_get_Camera_target_z(oStruct)
		up.x = raylib_get_Camera_up_x(oStruct)
		up.y = raylib_get_Camera_up_y(oStruct)
