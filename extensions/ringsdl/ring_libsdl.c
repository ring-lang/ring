...
RING_FUNC(ring_SDLNet_UDP_SendV)
{
	...
	RING_API_RETNUMBER(SDLNet_UDP_SendV(* (UDPsocket  *) RING_API_GETCPOINTER(1,"UDPsocket"),(UDPpacket *) RING_API_GETCPOINTER(2,"UDPpacket"), (int ) RING_API_GETNUMBER(3)));
	if (RING_API_ISCPOINTERNOTASSIGNED(1))
		free(RING_API_GETCPOINTER(1,"UDPsocket"));
}
...
RING_FUNC(ring_SDLNet_UDP_RecvV)
{
	...
	RING_API_RETNUMBER(SDLNet_UDP_RecvV(* (UDPsocket  *) RING_API_GETCPOINTER(1,"UDPsocket"),(UDPpacket *) RING_API_GETCPOINTER(2,"UDPpacket")));
	if (RING_API_ISCPOINTERNOTASSIGNED(1))
		free(RING_API_GETCPOINTER(1,"UDPsocket"));
}
...
RING_FUNC(ring_SDLNet_FreePacketV)
{
	...
	SDLNet_FreePacketV((UDPpacket *) RING_API_GETCPOINTER(1,"UDPpacket"));
}
