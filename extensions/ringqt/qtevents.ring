...
class <T_CLASSNAME> : public <T_REALCLASSNAME>
{
  ...
  public:
    ...
    <T_CLASSNAME>(<T_INITPARA>parent,VM *pVM );
...
`	# End of Code String
	...
	for aEvent in aEvents
		# Events Attributes
		cEventsAttributes += "char c"+aEvent[:event]+"Event[100];"+nl
		# Set Events 
		cSetEvents += "void set"+aEvent[:event]+"Event(const char *cStr);"+nl
		# Events Slots
		cEventsSlots += "void "+aEvent[:slot]+";"+nl
	Next
