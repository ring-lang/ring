...
curl_easy_setopt_1(curl, CURLOPT_HEADER, 0)
curl_easy_setopt_1(curl, CURLOPT_FOLLOWLOCATION, 1)
curl_easy_setopt_2(curl, CURLOPT_COOKIEJAR, "cookies.txt")
curl_easy_setopt_2(curl, CURLOPT_COOKIEFILE, "cookies.txt")
curl_easy_setopt_2(curl, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8.1.3) Gecko/20070309 Firefox/2.0.0.3")
curl_easy_setopt_2(curl, CURLOPT_REFERER, "http://www.facebook.com")
