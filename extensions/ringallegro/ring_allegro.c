...
static void *ringallegro_mutex_create(void) {
	return al_create_mutex();
}

static void ringallegro_mutex_lock(void *mutex) {
	al_lock_mutex((ALLEGRO_MUTEX *) mutex);
}

static void ringallegro_mutex_unlock(void *mutex) {
	al_unlock_mutex((ALLEGRO_MUTEX *) mutex);
}

static void ringallegro_mutex_destroy(void *mutex) {
	al_destroy_mutex((ALLEGRO_MUTEX *) mutex);
}
