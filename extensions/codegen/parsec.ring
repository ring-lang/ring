...
aPassPointers = [
	[True,"short","RING_API_GETSHORTINTPOINTER","RING_API_ACCEPTSHORTINTVALUE"],
	[True,"short int","RING_API_GETSHORTINTPOINTER","RING_API_ACCEPTSHORTINTVALUE"],
	[True,"unsigned short","RING_API_GETUNSIGNEDSHORTINTPOINTER","RING_API_ACCEPTUNSIGNEDSHORTINTVALUE"],
	[True,"unsigned short int","RING_API_GETUNSIGNEDSHORTINTPOINTER","RING_API_ACCEPTUNSIGNEDSHORTINTVALUE"],
	[True,"int","RING_API_GETINTPOINTER","RING_API_ACCEPTINTVALUE"],
	[True,"unsigned","RING_API_GETUNSIGNEDINTPOINTER","RING_API_ACCEPTUNSIGNEDINTVALUE"],
	[True,"unsigned int","RING_API_GETUNSIGNEDINTPOINTER","RING_API_ACCEPTUNSIGNEDINTVALUE"],
	[True,"long","RING_API_GETLONGINTPOINTER","RING_API_ACCEPTLONGINTVALUE"],
	[True,"long int","RING_API_GETLONGINTPOINTER","RING_API_ACCEPTLONGINTVALUE"],
	[True,"unsigned long","RING_API_GETUNSIGNEDLONGINTPOINTER","RING_API_ACCEPTUNSIGNEDLONGINTVALUE"],
	[True,"unsigned long int","RING_API_GETUNSIGNEDLONGINTPOINTER","RING_API_ACCEPTUNSIGNEDLONGINTVALUE"],
	[True,"float","RING_API_GETFLOATPOINTER","RING_API_ACCEPTFLOATVALUE"],
