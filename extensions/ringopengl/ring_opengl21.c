...
RING_FUNC(ring_glXChooseFBConfig)
{
	if ( RING_API_PARACOUNT != 4 ) {
		RING_API_ERROR(RING_API_MISS4PARA);
		return ;
	...
	RING_API_RETCPOINTER(glXChooseFBConfig((Display *) RING_API_GETCPOINTER(1,"Display"), (int ) RING_API_GETNUMBER(2),RING_API_GETINTPOINTER(3),RING_API_GETINTPOINTER(4)),"GLXFBConfig");
...
RING_FUNC(ring_glXCreateContext)
{
	if ( RING_API_PARACOUNT != 4 ) {
		RING_API_ERROR(RING_API_MISS4PARA);
		return ;
	...
	{
		GLXContext *pValue ; 
		pValue = (GLXContext *) malloc(sizeof(GLXContext)) ;
		*pValue = glXCreateContext((Display *) RING_API_GETCPOINTER(1,"Display"),(XVisualInfo *) RING_API_GETCPOINTER(2,"XVisualInfo"),* (GLXContext  *) RING_API_GETCPOINTER(3,"GLXContext"),* (Bool  *) RING_API_GETCPOINTER(4,"Bool"));
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"GLXContext"));
	if (RING_API_ISCPOINTERNOTASSIGNED(4))
		free(RING_API_GETCPOINTER(4,"Bool"));
		RING_API_RETCPOINTER(pValue,"GLXContext");
	}
}
...
RING_FUNC(ring_glXCreateNewContext)
{
	if ( RING_API_PARACOUNT != 5 ) {
		RING_API_ERROR(RING_API_BADPARACOUNT);
		return ;
	...
	}
	{
		GLXContext *pValue ; 
		pValue = (GLXContext *) malloc(sizeof(GLXContext)) ;
		*pValue = glXCreateNewContext((Display *) RING_API_GETCPOINTER(1,"Display"),* (GLXFBConfig  *) RING_API_GETCPOINTER(2,"GLXFBConfig"), (int ) RING_API_GETNUMBER(3),* (GLXContext  *) RING_API_GETCPOINTER(4,"GLXContext"),* (Bool  *) RING_API_GETCPOINTER(5,"Bool"));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"GLXFBConfig"));
	if (RING_API_ISCPOINTERNOTASSIGNED(4))
		free(RING_API_GETCPOINTER(4,"GLXContext"));
	if (RING_API_ISCPOINTERNOTASSIGNED(5))
		free(RING_API_GETCPOINTER(5,"Bool"));
		RING_API_RETCPOINTER(pValue,"GLXContext");
	}
}


RING_FUNC(ring_glXCreatePbuffer)
{
	if ( RING_API_PARACOUNT != 3 ) {
		RING_API_ERROR(RING_API_MISS3PARA);
		return ;
	...
	{
		GLXPbuffer *pValue ; 
		pValue = (GLXPbuffer *) malloc(sizeof(GLXPbuffer)) ;
		*pValue = glXCreatePbuffer((Display *) RING_API_GETCPOINTER(1,"Display"),* (GLXFBConfig  *) RING_API_GETCPOINTER(2,"GLXFBConfig"),RING_API_GETINTPOINTER(3));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"GLXFBConfig"));
		RING_API_RETCPOINTER(pValue,"GLXPbuffer");
	}
	RING_API_ACCEPTINTVALUE(3) ;
}
...
RING_FUNC(ring_glXCreateWindow)
{
	if ( RING_API_PARACOUNT != 4 ) {
		RING_API_ERROR(RING_API_MISS4PARA);
		return ;
	...
	{
		GLXWindow *pValue ; 
		pValue = (GLXWindow *) malloc(sizeof(GLXWindow)) ;
		*pValue = glXCreateWindow((Display *) RING_API_GETCPOINTER(1,"Display"),* (GLXFBConfig  *) RING_API_GETCPOINTER(2,"GLXFBConfig"),* (Window  *) RING_API_GETCPOINTER(3,"Window"),RING_API_GETINTPOINTER(4));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"GLXFBConfig"));
	if (RING_API_ISCPOINTERNOTASSIGNED(3))
		free(RING_API_GETCPOINTER(3,"Window"));
		RING_API_RETCPOINTER(pValue,"GLXWindow");
	}
	RING_API_ACCEPTINTVALUE(4) ;
}


RING_FUNC(ring_glXDestroyContext)
{
	if ( RING_API_PARACOUNT != 2 ) {
		RING_API_ERROR(RING_API_MISS2PARA);
		return ;
	...
	glXDestroyContext((Display *) RING_API_GETCPOINTER(1,"Display"),* (GLXContext  *) RING_API_GETCPOINTER(2,"GLXContext"));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"GLXContext"));
}


RING_FUNC(ring_glXDestroyGLXPixmap)
{
	if ( RING_API_PARACOUNT != 2 ) {
		RING_API_ERROR(RING_API_MISS2PARA);
		return ;
	...
	glXDestroyGLXPixmap((Display *) RING_API_GETCPOINTER(1,"Display"),* (GLXPixmap  *) RING_API_GETCPOINTER(2,"GLXPixmap"));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
		free(RING_API_GETCPOINTER(2,"GLXPixmap"));
}


RING_FUNC(ring_glXDestroyPbuffer)
{
	if ( RING_API_PARACOUNT != 2 ) {
		RING_API_ERROR(RING_API_MISS2PARA);
		return ;
	...
	glXDestroyPbuffer((Display *) RING_API_GETCPOINTER(1,"Display"),* (GLXPbuffer  *) RING_API_GETCPOINTER(2,"GLXPbuffer"));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
...
RING_FUNC(ring_glXDestroyWindow)
{
	if ( RING_API_PARACOUNT != 2 ) {
		RING_API_ERROR(RING_API_MISS2PARA);
		return ;
	...
	glXDestroyWindow((Display *) RING_API_GETCPOINTER(1,"Display"),* (GLXWindow  *) RING_API_GETCPOINTER(2,"GLXWindow"));
	if (RING_API_ISCPOINTERNOTASSIGNED(2))
...
RING_FUNC(ring_glXGetClientString)
{
	if ( RING_API_PARACOUNT != 2 ) {
		RING_API_ERROR(RING_API_MISS2PARA);
		return ;
	...
	RING_API_RETSTRING(glXGetClientString((Display *) RING_API_GETCPOINTER(1,"Display"), (int ) RING_API_GETNUMBER(2)));
}


RING_FUNC(ring_glXGetConfig)
{
	if ( RING_API_PARACOUNT != 4 ) {
		RING_API_ERROR(RING_API_MISS4PARA);
		return ;
	...
	RING_API_RETNUMBER(glXGetConfig((Display *) RING_API_GETCPOINTER(1,"Display"),(XVisualInfo *) RING_API_GETCPOINTER(2,"XVisualInfo"), (int ) RING_API_GETNUMBER(3),RING_API_GETINTPOINTER(4)));
	RING_API_ACCEPTINTVALUE(4) ;
}
...
RING_FUNC(ring_glXGetCurrentContext)
{
	if ( RING_API_PARACOUNT != 0 ) {
		RING_API_ERROR(RING_API_BADPARACOUNT);
		return ;
...
RING_FUNC(ring_glXGetCurrentDrawable)
{
	if ( RING_API_PARACOUNT != 0 ) {
		RING_API_ERROR(RING_API_BADPARACOUNT);
		return ;
...
RING_FUNC(ring_glXGetFBConfigs)
{
	if ( RING_API_PARACOUNT != 3 ) {
		RING_API_ERROR(RING_API_MISS3PARA);
		return ;
	...
	RING_API_RETCPOINTER(glXGetFBConfigs((Display *) RING_API_GETCPOINTER(1,"Display"), (int ) RING_API_GETNUMBER(2),RING_API_GETINTPOINTER(3)),"GLXFBConfig");
	RING_API_ACCEPTINTVALUE(3) ;
}
...
RING_API void ringlib_init(RingState *pRingState)
{
	...
	ring_vm_funcregister("glxcreatewindow",ring_glXCreateWindow);
	...
	ring_vm_funcregister("glxgetfbconfigs",ring_glXGetFBConfigs);
}
