...
RING_API void ringlib_init(RingState *pRingState)
{
	...
	ring_vm_funcregister("get_gl_transform_feedback_stream_overflow",ring_get_gl_transform_feedback_stream_overflow);
	ring_vm_funcregister("get_gl_vertices_submitted",ring_get_gl_vertices_submitted);
	ring_vm_funcregister("get_gl_primitives_submitted",ring_get_gl_primitives_submitted);
	ring_vm_funcregister("get_gl_vertex_shader_invocations",ring_get_gl_vertex_shader_invocations);
	ring_vm_funcregister("get_gl_tess_control_shader_patches",ring_get_gl_tess_control_shader_patches);
	ring_vm_funcregister("get_gl_tess_evaluation_shader_invocations",ring_get_gl_tess_evaluation_shader_invocations);
	ring_vm_funcregister("get_gl_geometry_shader_primitives_emitted",ring_get_gl_geometry_shader_primitives_emitted);
	ring_vm_funcregister("get_gl_fragment_shader_invocations",ring_get_gl_fragment_shader_invocations);
	ring_vm_funcregister("get_gl_compute_shader_invocations",ring_get_gl_compute_shader_invocations);
	ring_vm_funcregister("get_gl_clipping_input_primitives",ring_get_gl_clipping_input_primitives);
	ring_vm_funcregister("get_gl_clipping_output_primitives",ring_get_gl_clipping_output_primitives);
	ring_vm_funcregister("get_gl_texture_max_anisotropy",ring_get_gl_texture_max_anisotropy);
	ring_vm_funcregister("get_gl_max_texture_max_anisotropy",ring_get_gl_max_texture_max_anisotropy);
	ring_vm_funcregister("get_gl_polygon_offset_clamp",ring_get_gl_polygon_offset_clamp);
	ring_vm_funcregister("get_gl_shader_binary_format_spir_v",ring_get_gl_shader_binary_format_spir_v);
	ring_vm_funcregister("get_gl_spir_v_binary",ring_get_gl_spir_v_binary);
	ring_vm_funcregister("get_gl_spir_v_extensions",ring_get_gl_spir_v_extensions);
	ring_vm_funcregister("get_gl_num_spir_v_extensions",ring_get_gl_num_spir_v_extensions);
}
