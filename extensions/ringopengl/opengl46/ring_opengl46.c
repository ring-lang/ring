...
RING_FUNC(ring_get_gl_parameter_buffer_binding)
{
	RING_API_RETNUMBER(GL_PARAMETER_BUFFER_BINDING);
}

RING_FUNC(ring_get_gl_transform_feedback_overflow)
{
	RING_API_RETNUMBER(GL_TRANSFORM_FEEDBACK_OVERFLOW);
}

RING_FUNC(ring_get_gl_transform_feedback_stream_overflow)
{
	RING_API_RETNUMBER(GL_TRANSFORM_FEEDBACK_STREAM_OVERFLOW);
}

RING_FUNC(ring_get_gl_vertices_submitted)
{
	RING_API_RETNUMBER(GL_VERTICES_SUBMITTED);
}

RING_FUNC(ring_get_gl_primitives_submitted)
{
	RING_API_RETNUMBER(GL_PRIMITIVES_SUBMITTED);
}

RING_FUNC(ring_get_gl_vertex_shader_invocations)
{
	RING_API_RETNUMBER(GL_VERTEX_SHADER_INVOCATIONS);
}

RING_FUNC(ring_get_gl_tess_control_shader_patches)
{
	RING_API_RETNUMBER(GL_TESS_CONTROL_SHADER_PATCHES);
}

RING_FUNC(ring_get_gl_tess_evaluation_shader_invocations)
{
	RING_API_RETNUMBER(GL_TESS_EVALUATION_SHADER_INVOCATIONS);
}

RING_FUNC(ring_get_gl_geometry_shader_primitives_emitted)
{
	RING_API_RETNUMBER(GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED);
}

RING_FUNC(ring_get_gl_fragment_shader_invocations)
{
	RING_API_RETNUMBER(GL_FRAGMENT_SHADER_INVOCATIONS);
}

RING_FUNC(ring_get_gl_compute_shader_invocations)
{
	RING_API_RETNUMBER(GL_COMPUTE_SHADER_INVOCATIONS);
}

RING_FUNC(ring_get_gl_clipping_input_primitives)
{
	RING_API_RETNUMBER(GL_CLIPPING_INPUT_PRIMITIVES);
}

RING_FUNC(ring_get_gl_clipping_output_primitives)
{
	RING_API_RETNUMBER(GL_CLIPPING_OUTPUT_PRIMITIVES);
}

RING_FUNC(ring_get_gl_texture_max_anisotropy)
{
	RING_API_RETNUMBER(GL_TEXTURE_MAX_ANISOTROPY);
}

RING_FUNC(ring_get_gl_max_texture_max_anisotropy)
{
	RING_API_RETNUMBER(GL_MAX_TEXTURE_MAX_ANISOTROPY);
}

RING_FUNC(ring_get_gl_polygon_offset_clamp)
{
	RING_API_RETNUMBER(GL_POLYGON_OFFSET_CLAMP);
}

RING_FUNC(ring_get_gl_shader_binary_format_spir_v)
{
	RING_API_RETNUMBER(GL_SHADER_BINARY_FORMAT_SPIR_V);
}

RING_FUNC(ring_get_gl_spir_v_binary)
{
	RING_API_RETNUMBER(GL_SPIR_V_BINARY);
}

RING_FUNC(ring_get_gl_spir_v_extensions)
{
	RING_API_RETNUMBER(GL_SPIR_V_EXTENSIONS);
}

RING_FUNC(ring_get_gl_num_spir_v_extensions)
{
	RING_API_RETNUMBER(GL_NUM_SPIR_V_EXTENSIONS);
}
...
RING_LIBINIT
{
	...
	RING_API_REGISTER("get_gl_vertex_attrib_array_divisor",ring_get_gl_vertex_attrib_array_divisor);
	RING_API_REGISTER("get_gl_rgb10_a2ui",ring_get_gl_rgb10_a2ui);
	RING_API_REGISTER("get_gl_sample_shading",ring_get_gl_sample_shading);
	RING_API_REGISTER("get_gl_min_sample_shading_value",ring_get_gl_min_sample_shading_value);
	RING_API_REGISTER("get_gl_min_program_texture_gather_offset",ring_get_gl_min_program_texture_gather_offset);
	RING_API_REGISTER("get_gl_max_program_texture_gather_offset",ring_get_gl_max_program_texture_gather_offset);
	RING_API_REGISTER("get_gl_max_program_texture_gather_components",ring_get_gl_max_program_texture_gather_components);
	RING_API_REGISTER("get_gl_texture_cube_map_array",ring_get_gl_texture_cube_map_array);
	RING_API_REGISTER("get_gl_texture_binding_cube_map_array",ring_get_gl_texture_binding_cube_map_array);
	RING_API_REGISTER("get_gl_proxy_texture_cube_map_array",ring_get_gl_proxy_texture_cube_map_array);
	RING_API_REGISTER("get_gl_sampler_cube_map_array",ring_get_gl_sampler_cube_map_array);
	RING_API_REGISTER("get_gl_sampler_cube_map_array_shadow",ring_get_gl_sampler_cube_map_array_shadow);
	RING_API_REGISTER("get_gl_int_sampler_cube_map_array",ring_get_gl_int_sampler_cube_map_array);
	RING_API_REGISTER("get_gl_unsigned_int_sampler_cube_map_array",ring_get_gl_unsigned_int_sampler_cube_map_array);
	RING_API_REGISTER("get_gl_transform_feedback_paused",ring_get_gl_transform_feedback_paused);
	RING_API_REGISTER("get_gl_transform_feedback_active",ring_get_gl_transform_feedback_active);
	RING_API_REGISTER("get_gl_compressed_rgba_bptc_unorm",ring_get_gl_compressed_rgba_bptc_unorm);
	RING_API_REGISTER("get_gl_compressed_srgb_alpha_bptc_unorm",ring_get_gl_compressed_srgb_alpha_bptc_unorm);
	RING_API_REGISTER("get_gl_compressed_rgb_bptc_signed_float",ring_get_gl_compressed_rgb_bptc_signed_float);
	RING_API_REGISTER("get_gl_compressed_rgb_bptc_unsigned_float",ring_get_gl_compressed_rgb_bptc_unsigned_float);
	RING_API_REGISTER("get_gl_copy_read_buffer_binding",ring_get_gl_copy_read_buffer_binding);
	RING_API_REGISTER("get_gl_copy_write_buffer_binding",ring_get_gl_copy_write_buffer_binding);
	RING_API_REGISTER("get_gl_num_shading_language_versions",ring_get_gl_num_shading_language_versions);
	RING_API_REGISTER("get_gl_vertex_attrib_array_long",ring_get_gl_vertex_attrib_array_long);
	RING_API_REGISTER("get_gl_primitive_restart_for_patches_supported",ring_get_gl_primitive_restart_for_patches_supported);
	RING_API_REGISTER("get_gl_max_vertex_attrib_stride",ring_get_gl_max_vertex_attrib_stride);
	RING_API_REGISTER("get_gl_texture_buffer_binding",ring_get_gl_texture_buffer_binding);
	RING_API_REGISTER("get_gl_context_flag_robust_access_bit",ring_get_gl_context_flag_robust_access_bit);
	RING_API_REGISTER("get_gl_parameter_buffer",ring_get_gl_parameter_buffer);
	RING_API_REGISTER("get_gl_parameter_buffer_binding",ring_get_gl_parameter_buffer_binding);
	RING_API_REGISTER("get_gl_transform_feedback_overflow",ring_get_gl_transform_feedback_overflow);
	RING_API_REGISTER("get_gl_transform_feedback_stream_overflow",ring_get_gl_transform_feedback_stream_overflow);
	RING_API_REGISTER("get_gl_vertices_submitted",ring_get_gl_vertices_submitted);
	RING_API_REGISTER("get_gl_primitives_submitted",ring_get_gl_primitives_submitted);
	RING_API_REGISTER("get_gl_vertex_shader_invocations",ring_get_gl_vertex_shader_invocations);
	RING_API_REGISTER("get_gl_tess_control_shader_patches",ring_get_gl_tess_control_shader_patches);
	RING_API_REGISTER("get_gl_tess_evaluation_shader_invocations",ring_get_gl_tess_evaluation_shader_invocations);
	RING_API_REGISTER("get_gl_geometry_shader_primitives_emitted",ring_get_gl_geometry_shader_primitives_emitted);
	RING_API_REGISTER("get_gl_fragment_shader_invocations",ring_get_gl_fragment_shader_invocations);
	RING_API_REGISTER("get_gl_compute_shader_invocations",ring_get_gl_compute_shader_invocations);
	RING_API_REGISTER("get_gl_clipping_input_primitives",ring_get_gl_clipping_input_primitives);
	RING_API_REGISTER("get_gl_clipping_output_primitives",ring_get_gl_clipping_output_primitives);
	RING_API_REGISTER("get_gl_texture_max_anisotropy",ring_get_gl_texture_max_anisotropy);
	RING_API_REGISTER("get_gl_max_texture_max_anisotropy",ring_get_gl_max_texture_max_anisotropy);
	RING_API_REGISTER("get_gl_polygon_offset_clamp",ring_get_gl_polygon_offset_clamp);
	RING_API_REGISTER("get_gl_shader_binary_format_spir_v",ring_get_gl_shader_binary_format_spir_v);
	RING_API_REGISTER("get_gl_spir_v_binary",ring_get_gl_spir_v_binary);
	RING_API_REGISTER("get_gl_spir_v_extensions",ring_get_gl_spir_v_extensions);
	RING_API_REGISTER("get_gl_num_spir_v_extensions",ring_get_gl_num_spir_v_extensions);
}
