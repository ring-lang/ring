/* Copyright (c) 2013-2024 Mahmoud Fayed <msfclipper@yahoo.com> */
	...
	*/
	...
	#define RING_VM_IR_READIVALUE(x) pVM->pByteCodeIR->aReg[x].iNumber
	...
	*/
	...
	#define RING_BRACEOBJECTS_ASETPROPERTY 6
	...
	#define RING_ASETPROPERTY_ATTRNAME 3
	#define RING_ASETPROPERTY_ATTRVAR 4
	#define RING_ASETPROPERTY_NBEFOREEQUAL 5
	#define RING_ASETPROPERTY_VALUE 6
	#define RING_ASETPROPERTY_VALUEOBJTYPE 7
	/* State */
