...
clang -c -fpic ring_pcre.c pcre2lib/pcre2_auto_possess.c pcre2lib/pcre2_chartables.c \
...
clang -dynamiclib -o lib/libring_pcre2.dylib *.o

rm *.o

cp lib/libring_pcre2.dylib /usr/local/lib/ring/libring_pcre2.dylib
