...
if number(version()) >= 1.25
	aKEYWORDS = [
		...
		"THIS","SELF","SUPER",
		"MAIN","INIT","OPERATOR",
		"BRACESTART","BRACEEXPREVAL","BRACEERROR","BRACEEND",
...
if number(version()) >= 1.25
	...
	K_RINGVMSEE             = 67
	K_RINGVMGIVE            = 68
        K_RINGVMERRORHANDLER    = 69
	K_CHANGERINGKEYWORD     = 70
	K_CHANGERINGOPERATOR    = 71
	K_LOADSYNTAX            = 72
	K_ENABLEHASHCOMMENTS    = 73
	K_DISABLEHASHCOMMENTS   = 74
else
