// A Linear Transformation Defined by a Matrix p 357, 359
...
//================================================
//================================================
// Linear Transformation Defined by a Matrix p357
// T(v) = Av =
...
T1 = [[r1 * cos(Ta)],         
      [r1 * sin(Ta)]]
See "Initial-45  x-y  T1 PI/6=30 Va = PI/4=45  "  MatrixPrint(T1)
 
A1 = [[cos(Ta), -sin(Ta)],
      [sin(Ta),  cos(Ta)]]
See "Transform A1 x-y angle Ta = PI/6-30 "  MatrixPrint(A1)
...
See "EndPoint-75 Av x-y A1xV1 Radius: "+r1 +" Ta: "+Ta  +" Va: "+Va   MatrixPrint(Av)
